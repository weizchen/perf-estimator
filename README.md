...
See [`PLAN.md`](PLAN.md) for the full design (technical decisions, corpus structure, repo diff, verification). The previous Gemini-drafted background docs are preserved under [`doc/archive/`](doc/archive/).
