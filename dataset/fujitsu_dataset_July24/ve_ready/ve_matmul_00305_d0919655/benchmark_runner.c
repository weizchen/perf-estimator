...
int main(void) {
  fill_bf16(input0_storage, 442368, 1);
  fill_bf16(input1_storage, 614400, 2);
  fill_f32(input2_storage, 1843200, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1152, 384, 384, 1, input1_storage, input1_storage, 0, 384, 1600, 1600, 1, input2_storage, input2_storage, 0, 1152, 1600, 1600, 1, output0_storage, output0_storage, 0, 1152, 1600, 1600, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00305_d0919655: benchmark completed");
