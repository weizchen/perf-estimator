...
static int16_t input1_storage[137] __attribute__((aligned(64)));
static int16_t output0_storage[137] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00845_45ea0fd8: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 137));
  return 0;
}
