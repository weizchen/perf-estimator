...
int main(void) {
  fill_bf16(input0_storage, 663552, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 576, 576, 1, input1_storage, input1_storage, 0, 576, 64, 64, 1, input2_storage, input2_storage, 0, 1152, 64, 64, 1, output0_storage, output0_storage, 0, 1152, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00337_dc6928c7: benchmark completed");
