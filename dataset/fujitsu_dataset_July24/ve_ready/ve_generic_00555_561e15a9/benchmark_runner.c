...
static int8_t input1_storage[75] __attribute__((aligned(64)));
static int8_t output0_storage[75] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00555_561e15a9: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 75));
  return 0;
}
