...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2688, 128, 128, 1, input1_storage, input1_storage, 0, 128, 256, 256, 1, input2_storage, input2_storage, 0, 2688, 256, 256, 1, output0_storage, output0_storage, 0, 2688, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00087_5ace78cb: benchmark completed");
