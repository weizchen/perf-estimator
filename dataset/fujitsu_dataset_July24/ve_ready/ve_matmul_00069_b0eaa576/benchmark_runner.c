...
static int8_t input0_storage[737280] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 737280, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1920, 384, 384, 1, input1_storage, input1_storage, 0, 384, 256, 256, 1, input2_storage, input2_storage, 0, 1920, 256, 256, 1, output0_storage, output0_storage, 0, 1920, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00069_b0eaa576: benchmark completed");
