...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 256, 256, 1, input1_storage, input1_storage, 0, 256, 2432, 2432, 1, input2_storage, input2_storage, 0, 128, 2432, 2432, 1, output0_storage, output0_storage, 0, 128, 2432, 2432, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00466_bff861d8: benchmark completed");
