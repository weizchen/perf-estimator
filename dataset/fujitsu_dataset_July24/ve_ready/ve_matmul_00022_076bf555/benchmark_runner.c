...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 768, 768, 1, input2_storage, input2_storage, 0, 768, 768, 768, 1, output0_storage, output0_storage, 0, 768, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00022_076bf555: benchmark completed");
