...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 1, input1_storage, input1_storage, 0, 128, 1, output0_storage, output0_storage, 0, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_generic_00049_484bfc6e: benchmark completed");
