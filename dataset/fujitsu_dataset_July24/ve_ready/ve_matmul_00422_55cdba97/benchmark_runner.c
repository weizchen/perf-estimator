...
static float input1_storage[294912] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 294912, 2);
  fill_f32(input2_storage, 147456, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 384, 384, 1, input1_storage, input1_storage, 0, 384, 768, 768, 1, input2_storage, input2_storage, 0, 192, 768, 768, 1, output0_storage, output0_storage, 0, 192, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00422_55cdba97: benchmark completed");
