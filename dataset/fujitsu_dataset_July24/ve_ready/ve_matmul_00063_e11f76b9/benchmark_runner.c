...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 512, 512, 1, input1_storage, input1_storage, 0, 512, 384, 384, 1, input2_storage, input2_storage, 0, 768, 384, 384, 1, output0_storage, output0_storage, 0, 768, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00063_e11f76b9: benchmark completed");
