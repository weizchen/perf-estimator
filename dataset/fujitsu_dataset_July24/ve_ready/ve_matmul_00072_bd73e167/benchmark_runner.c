...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 256, 256, 1, input2_storage, input2_storage, 0, 640, 256, 256, 1, output0_storage, output0_storage, 0, 640, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00072_bd73e167: benchmark completed");
