...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1536, 384, 384, 1, input1_storage, input1_storage, 0, 384, 192, 192, 1, input2_storage, input2_storage, 0, 1536, 192, 192, 1, output0_storage, output0_storage, 0, 1536, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00458_7832e957: benchmark completed");
