...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1280, 1280, 1, input2_storage, input2_storage, 0, 704, 1280, 1280, 1, output0_storage, output0_storage, 0, 704, 1280, 1280, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00216_2ce4ba93: benchmark completed");
