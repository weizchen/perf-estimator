...
int main(void) {
  fill_bf16(input0_storage, 1802240, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 704, 2560, 2560, 1, input1_storage, input1_storage, 0, 2560, 384, 384, 1, input2_storage, input2_storage, 0, 704, 384, 384, 1, output0_storage, output0_storage, 0, 704, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00344_c31d2c46: benchmark completed");
