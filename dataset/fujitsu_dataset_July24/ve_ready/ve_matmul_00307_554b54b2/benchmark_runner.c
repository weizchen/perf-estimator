...
static uint16_t input0_storage[4669440] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 4669440, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3648, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 64, 64, 1, input2_storage, input2_storage, 0, 3648, 64, 64, 1, output0_storage, output0_storage, 0, 3648, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00307_554b54b2: benchmark completed");
