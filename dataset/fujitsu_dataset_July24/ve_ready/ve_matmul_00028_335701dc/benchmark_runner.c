...
static int8_t input0_storage[2654208] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 2654208, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 768, 3456, 3456, 1, input1_storage, input1_storage, 0, 3456, 896, 896, 1, input2_storage, input2_storage, 0, 768, 896, 896, 1, output0_storage, output0_storage, 0, 768, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00028_335701dc: benchmark completed");
