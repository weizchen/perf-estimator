...
static int8_t input1_storage[2228224] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 2228224, 2);
  fill_i32(input2_storage, 557056, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 2176, 2176, 1, input2_storage, input2_storage, 0, 256, 2176, 2176, 1, output0_storage, output0_storage, 0, 256, 2176, 2176, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00049_f1a60ee1: benchmark completed");
