...
static int8_t input1_storage[2260992] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 2260992, 2);
  fill_i32(input2_storage, 98304, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2944, 2944, 1, input1_storage, input1_storage, 0, 2944, 768, 768, 1, input2_storage, input2_storage, 0, 128, 768, 768, 1, output0_storage, output0_storage, 0, 128, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00048_eb54cc09: benchmark completed");
