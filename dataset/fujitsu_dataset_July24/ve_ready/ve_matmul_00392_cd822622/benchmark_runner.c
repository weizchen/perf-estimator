...
int main(void) {
  ...
  fill_bf16(input1_storage, 1032192, 2);
  fill_f32(input2_storage, 344064, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 896, 896, 1, input2_storage, input2_storage, 0, 384, 896, 896, 1, output0_storage, output0_storage, 0, 384, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00392_cd822622: benchmark completed");
