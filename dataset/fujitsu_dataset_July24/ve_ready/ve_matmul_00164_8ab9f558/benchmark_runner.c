...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 256, 256, 1, input1_storage, input1_storage, 0, 256, 512, 512, 1, input2_storage, input2_storage, 0, 704, 512, 512, 1, output0_storage, output0_storage, 0, 704, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00164_8ab9f558: benchmark completed");
