...
static float input0_storage[602112] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 602112, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 1344, 1344, 1, input1_storage, input1_storage, 0, 1344, 256, 256, 1, input2_storage, input2_storage, 0, 448, 256, 256, 1, output0_storage, output0_storage, 0, 448, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00495_dad6409a: benchmark completed");
