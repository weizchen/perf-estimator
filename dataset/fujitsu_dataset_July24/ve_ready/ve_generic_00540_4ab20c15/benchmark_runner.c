...
static uint16_t input0_storage[85] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 85, 1);
  fill_bf16(input1_storage, 85, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00540_4ab20c15: benchmark completed");
