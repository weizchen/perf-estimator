...
static float input1_storage[360448] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 360448, 2);
  fill_f32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 704, 704, 1, input1_storage, input1_storage, 0, 704, 512, 512, 1, input2_storage, input2_storage, 0, 128, 512, 512, 1, output0_storage, output0_storage, 0, 128, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00414_c79523cc: benchmark completed");
