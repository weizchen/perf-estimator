...
int main(void) {
  fill_bf16(input0_storage, 249856, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 3904, 3904, 1, input1_storage, input1_storage, 0, 3904, 960, 960, 1, input2_storage, input2_storage, 0, 64, 960, 960, 1, output0_storage, output0_storage, 0, 64, 960, 960, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00326_a56824f5: benchmark completed");
