...
int main(void) {
  fill_f16(input0_storage, 22, 1);
  fill_f16(input1_storage, 22, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 22, 1, input1_storage, input1_storage, 0, 22, 1, output0_storage, output0_storage, 0, 22, 1);
  ofa_dma_memory_fence();
  puts("ve_elementwise_00005_0dcb3370: benchmark completed");
