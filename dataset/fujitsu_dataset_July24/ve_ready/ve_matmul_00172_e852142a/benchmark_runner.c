...
static uint16_t input1_storage[450560] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 450560, 2);
  fill_f32(input2_storage, 2883584, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2048, 320, 320, 1, input1_storage, input1_storage, 0, 320, 1408, 1408, 1, input2_storage, input2_storage, 0, 2048, 1408, 1408, 1, output0_storage, output0_storage, 0, 2048, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00172_e852142a: benchmark completed");
