...
int main(void) {
  ...
  fill_bf16(input1_storage, 12288, 2);
  fill_f32(input2_storage, 159744, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 832, 64, 64, 1, input1_storage, input1_storage, 0, 64, 192, 192, 1, input2_storage, input2_storage, 0, 832, 192, 192, 1, output0_storage, output0_storage, 0, 832, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00346_0c0cfae3: benchmark completed");
