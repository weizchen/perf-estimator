...
int main(void) {
  fill_i1(input0_storage, 7095, 1);
  fill_i16(input1_storage, 7095, 2);
  fill_i16(input2_storage, 7095, 3);
  fill_i16(input3_storage, 7095, 4);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 15, 473, 473, 1, input1_storage, input1_storage, 0, 15, 473, 473, 1, input2_storage, input2_storage, 0, 15, 473, 473, 1, input3_storage, input3_storage, 0, 15, 473, 473, 1, output0_storage, output0_storage, 0, 15, 473, 473, 1);
  ofa_dma_memory_fence();
  puts("ve_select_00118_ef0612a1: benchmark completed");
