...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 256, 256, 1, input1_storage, input1_storage, 0, 256, 576, 576, 1, input2_storage, input2_storage, 0, 1280, 576, 576, 1, output0_storage, output0_storage, 0, 1280, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00141_0814f292: benchmark completed");
