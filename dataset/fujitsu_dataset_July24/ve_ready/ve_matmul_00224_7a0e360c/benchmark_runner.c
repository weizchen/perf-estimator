...
static uint16_t input1_storage[946176] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 946176, 2);
  fill_f16(input2_storage, 270336, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 448, 448, 1, input1_storage, input1_storage, 0, 448, 2112, 2112, 1, input2_storage, input2_storage, 0, 128, 2112, 2112, 1, output0_storage, output0_storage, 0, 128, 2112, 2112, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00224_7a0e360c: benchmark completed");
