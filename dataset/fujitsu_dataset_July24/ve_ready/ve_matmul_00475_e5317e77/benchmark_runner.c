...
static float input0_storage[1261568] __attribute__((aligned(64)));
static float input1_storage[172032] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1261568, 1);
  fill_f32(input1_storage, 172032, 2);
  fill_f32(input2_storage, 1081344, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2816, 448, 448, 1, input1_storage, input1_storage, 0, 448, 384, 384, 1, input2_storage, input2_storage, 0, 2816, 384, 384, 1, output0_storage, output0_storage, 0, 2816, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00475_e5317e77: benchmark completed");
