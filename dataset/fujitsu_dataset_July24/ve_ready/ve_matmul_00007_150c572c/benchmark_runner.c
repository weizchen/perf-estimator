...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 896, 3328, 3328, 1, input1_storage, input1_storage, 0, 3328, 512, 512, 1, input2_storage, input2_storage, 0, 896, 512, 512, 1, output0_storage, output0_storage, 0, 896, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00007_150c572c: benchmark completed");
