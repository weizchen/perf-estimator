...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 2112, 2112, 1, input1_storage, input1_storage, 0, 2112, 128, 128, 1, input2_storage, input2_storage, 0, 256, 128, 128, 1, output0_storage, output0_storage, 0, 256, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00212_cef4b592: benchmark completed");
