...
static uint16_t input0_storage[67] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 67, 1);
  fill_bf16(input1_storage, 67, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00599_5954ab8b: benchmark completed");
