...
static uint16_t input0_storage[9797632] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 9797632, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3328, 2944, 2944, 1, input1_storage, input1_storage, 0, 2944, 896, 896, 1, input2_storage, input2_storage, 0, 3328, 896, 896, 1, output0_storage, output0_storage, 0, 3328, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00376_45a23360: benchmark completed");
