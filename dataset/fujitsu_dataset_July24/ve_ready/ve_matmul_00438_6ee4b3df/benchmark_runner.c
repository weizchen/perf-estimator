...
static float input0_storage[98304] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 98304, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 768, 128, 128, 1, input1_storage, input1_storage, 0, 128, 576, 576, 1, input2_storage, input2_storage, 0, 768, 576, 576, 1, output0_storage, output0_storage, 0, 768, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00438_6ee4b3df: benchmark completed");
