...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 110, 1, input1_storage, input1_storage, 0, 110, 1, output0_storage, output0_storage, 0, 110, 1);
  ofa_dma_memory_fence();
  puts("ve_generic_00679_300ddbca: benchmark completed");
