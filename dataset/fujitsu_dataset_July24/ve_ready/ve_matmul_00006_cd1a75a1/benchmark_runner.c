...
static int32_t input2_storage[376832] __attribute__((aligned(64)));
static int32_t output0_storage[376832] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i32(input2_storage, 376832, 3);
  ...
  ofa_dma_memory_fence();
  puts("ve_matmul_00006_cd1a75a1: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 376832));
  return 0;
}
