...
static uint16_t input0_storage[7372800] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 7372800, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3840, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 256, 256, 1, input2_storage, input2_storage, 0, 3840, 256, 256, 1, output0_storage, output0_storage, 0, 3840, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00111_c149fa42: benchmark completed");
