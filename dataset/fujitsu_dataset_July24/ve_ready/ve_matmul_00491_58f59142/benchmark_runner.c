...
static float input0_storage[585728] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 585728, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 704, 832, 832, 1, input1_storage, input1_storage, 0, 832, 64, 64, 1, input2_storage, input2_storage, 0, 704, 64, 64, 1, output0_storage, output0_storage, 0, 704, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00491_58f59142: benchmark completed");
