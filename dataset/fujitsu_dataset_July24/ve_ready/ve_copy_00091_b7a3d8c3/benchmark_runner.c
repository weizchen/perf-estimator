...
static int16_t input0_storage[172] __attribute__((aligned(64)));
static int16_t input1_storage[172] __attribute__((aligned(64)));
static int16_t output0_storage[172] __attribute__((aligned(64)));
...
int main(void) {
  fill_i16(input0_storage, 172, 1);
  fill_i16(input1_storage, 172, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_copy_00091_b7a3d8c3: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 172));
  return 0;
}
