...
int main(void) {
  ...
  fill_f16(input1_storage, 774144, 2);
  fill_f16(input2_storage, 552960, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 448, 448, 1, input1_storage, input1_storage, 0, 448, 1728, 1728, 1, input2_storage, input2_storage, 0, 320, 1728, 1728, 1, output0_storage, output0_storage, 0, 320, 1728, 1728, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00298_8754ee4b: benchmark completed");
