...
static uint16_t input0_storage[2568192] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 2568192, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1216, 2112, 2112, 1, input1_storage, input1_storage, 0, 2112, 64, 64, 1, input2_storage, input2_storage, 0, 1216, 64, 64, 1, output0_storage, output0_storage, 0, 1216, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00198_3794f30d: benchmark completed");
