...
int main(void) {
  ...
  fill_bf16(input1_storage, 430080, 2);
  fill_f32(input2_storage, 286720, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 192, 192, 1, input1_storage, input1_storage, 0, 192, 2240, 2240, 1, input2_storage, input2_storage, 0, 128, 2240, 2240, 1, output0_storage, output0_storage, 0, 128, 2240, 2240, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00302_f266cebe: benchmark completed");
