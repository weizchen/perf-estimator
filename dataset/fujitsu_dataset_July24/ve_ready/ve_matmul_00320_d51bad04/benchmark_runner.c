...
int main(void) {
  fill_bf16(input0_storage, 286720, 1);
  fill_bf16(input1_storage, 286720, 2);
  fill_f32(input2_storage, 16384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2240, 2240, 1, input1_storage, input1_storage, 0, 2240, 128, 128, 1, input2_storage, input2_storage, 0, 128, 128, 128, 1, output0_storage, output0_storage, 0, 128, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00320_d51bad04: benchmark completed");
