...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 640, 640, 1, input1_storage, input1_storage, 0, 640, 128, 128, 1, input2_storage, input2_storage, 0, 512, 128, 128, 1, output0_storage, output0_storage, 0, 512, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00023_044eea73: benchmark completed");
