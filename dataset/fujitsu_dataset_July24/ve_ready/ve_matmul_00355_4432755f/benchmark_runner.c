...
int main(void) {
  ...
  fill_bf16(input1_storage, 110592, 2);
  fill_f32(input2_storage, 626688, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1088, 192, 192, 1, input1_storage, input1_storage, 0, 192, 576, 576, 1, input2_storage, input2_storage, 0, 1088, 576, 576, 1, output0_storage, output0_storage, 0, 1088, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00355_4432755f: benchmark completed");
