...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2176, 448, 448, 1, input1_storage, input1_storage, 0, 448, 128, 128, 1, input2_storage, input2_storage, 0, 2176, 128, 128, 1, output0_storage, output0_storage, 0, 2176, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00285_b5fa27c2: benchmark completed");
