...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 3840, 64, 64, 1, input1_storage, input1_storage, 0, 64, 576, 576, 1, input2_storage, input2_storage, 0, 3840, 576, 576, 1, output0_storage, output0_storage, 0, 3840, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00241_b1faa24d: benchmark completed");
