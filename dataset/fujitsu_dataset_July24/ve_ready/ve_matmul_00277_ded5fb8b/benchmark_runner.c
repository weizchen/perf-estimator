...
static uint16_t input1_storage[2015232] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 2015232, 2);
  fill_f16(input2_storage, 147456, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 2624, 2624, 1, input1_storage, input1_storage, 0, 2624, 768, 768, 1, input2_storage, input2_storage, 0, 192, 768, 768, 1, output0_storage, output0_storage, 0, 192, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00277_ded5fb8b: benchmark completed");
