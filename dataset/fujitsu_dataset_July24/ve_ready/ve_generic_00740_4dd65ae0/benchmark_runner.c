...
static float output0_storage[32] __attribute__((aligned(64)));
...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 32, 1, input1_storage, input1_storage, 0, 32, 1, output0_storage, output0_storage, 0, 32, 1);
  ofa_dma_memory_fence();
  puts("ve_generic_00740_4dd65ae0: benchmark completed");
  printf("output0_f32_checksum=%.10e\n", checksum_f32(output0_storage, 32));
  return 0;
}
