...
static uint16_t input1_storage[1638400] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1638400, 2);
  fill_f16(input2_storage, 245760, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 1280, 1280, 1, input2_storage, input2_storage, 0, 192, 1280, 1280, 1, output0_storage, output0_storage, 0, 192, 1280, 1280, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00206_8d37bc27: benchmark completed");
