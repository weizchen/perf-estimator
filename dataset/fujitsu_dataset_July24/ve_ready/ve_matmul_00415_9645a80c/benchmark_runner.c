...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 1728, 1728, 1, input1_storage, input1_storage, 0, 1728, 3136, 3136, 1, input2_storage, input2_storage, 0, 384, 3136, 3136, 1, output0_storage, output0_storage, 0, 384, 3136, 3136, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00415_9645a80c: benchmark completed");
