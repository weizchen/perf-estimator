...
int main(void) {
  ...
  fill_f16(input1_storage, 200704, 2);
  fill_f16(input2_storage, 602112, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 64, 64, 1, input1_storage, input1_storage, 0, 64, 3136, 3136, 1, input2_storage, input2_storage, 0, 192, 3136, 3136, 1, output0_storage, output0_storage, 0, 192, 3136, 3136, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00231_222c74a2: benchmark completed");
