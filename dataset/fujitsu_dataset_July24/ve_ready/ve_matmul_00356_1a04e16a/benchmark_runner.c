...
int main(void) {
  fill_bf16(input0_storage, 851968, 1);
  fill_bf16(input1_storage, 851968, 2);
  fill_f32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 3328, 3328, 1, input1_storage, input1_storage, 0, 3328, 256, 256, 1, input2_storage, input2_storage, 0, 256, 256, 256, 1, output0_storage, output0_storage, 0, 256, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00356_1a04e16a: benchmark completed");
