...
static float input0_storage[8126464] __attribute__((aligned(64)));
static float input1_storage[655360] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 8126464, 1);
  fill_f32(input1_storage, 655360, 2);
  fill_f32(input2_storage, 1269760, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 3968, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 320, 320, 1, input2_storage, input2_storage, 0, 3968, 320, 320, 1, output0_storage, output0_storage, 0, 3968, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00471_8173af7a: benchmark completed");
