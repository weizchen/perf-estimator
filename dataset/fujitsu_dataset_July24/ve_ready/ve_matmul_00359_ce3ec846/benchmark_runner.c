...
static uint16_t input0_storage[905216] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 905216, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1088, 832, 832, 1, input1_storage, input1_storage, 0, 832, 576, 576, 1, input2_storage, input2_storage, 0, 1088, 576, 576, 1, output0_storage, output0_storage, 0, 1088, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00359_ce3ec846: benchmark completed");
