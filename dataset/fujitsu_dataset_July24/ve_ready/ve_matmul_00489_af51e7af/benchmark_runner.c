...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 896, 896, 1, input1_storage, input1_storage, 0, 896, 1920, 1920, 1, input2_storage, input2_storage, 0, 64, 1920, 1920, 1, output0_storage, output0_storage, 0, 64, 1920, 1920, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00489_af51e7af: benchmark completed");
