...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 384, 384, 1, input1_storage, input1_storage, 0, 384, 1536, 1536, 1, input2_storage, input2_storage, 0, 256, 1536, 1536, 1, output0_storage, output0_storage, 0, 256, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00014_8f4a0cfd: benchmark completed");
