...
static float input0_storage[1671168] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1671168, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 768, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 192, 192, 1, input2_storage, input2_storage, 0, 768, 192, 192, 1, output0_storage, output0_storage, 0, 768, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00477_790ff1fa: benchmark completed");
