...
static int16_t input1_storage[117] __attribute__((aligned(64)));
static int16_t output0_storage[117] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("ve_copy_00126_5ae9b35e: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 117));
  return 0;
}
