...
static float input0_storage[200704] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 200704, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 448, 448, 1, input1_storage, input1_storage, 0, 448, 512, 512, 1, input2_storage, input2_storage, 0, 448, 512, 512, 1, output0_storage, output0_storage, 0, 448, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00400_f4e83090: benchmark completed");
