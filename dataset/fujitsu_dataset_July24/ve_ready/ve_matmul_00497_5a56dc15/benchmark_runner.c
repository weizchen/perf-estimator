...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 256, 256, 1, input1_storage, input1_storage, 0, 256, 3008, 3008, 1, input2_storage, input2_storage, 0, 64, 3008, 3008, 1, output0_storage, output0_storage, 0, 64, 3008, 3008, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00497_5a56dc15: benchmark completed");
