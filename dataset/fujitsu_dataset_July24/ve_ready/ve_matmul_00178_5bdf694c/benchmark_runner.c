...
static uint16_t input1_storage[1261568] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1261568, 2);
  fill_f32(input2_storage, 458752, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 896, 896, 1, input2_storage, input2_storage, 0, 512, 896, 896, 1, output0_storage, output0_storage, 0, 512, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00178_5bdf694c: benchmark completed");
