...
int main(void) {
  ...
  fill_bf16(input1_storage, 311296, 2);
  fill_f32(input2_storage, 622592, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 256, 256, 1, input1_storage, input1_storage, 0, 256, 1216, 1216, 1, input2_storage, input2_storage, 0, 512, 1216, 1216, 1, output0_storage, output0_storage, 0, 512, 1216, 1216, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00395_ad122416: benchmark completed");
