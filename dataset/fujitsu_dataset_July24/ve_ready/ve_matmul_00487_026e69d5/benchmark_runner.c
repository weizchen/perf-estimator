...
static float input1_storage[7741440] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 7741440, 2);
  fill_f32(input2_storage, 2064384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 4032, 4032, 1, input2_storage, input2_storage, 0, 512, 4032, 4032, 1, output0_storage, output0_storage, 0, 512, 4032, 4032, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00487_026e69d5: benchmark completed");
