...
static int8_t input0_storage[47] __attribute__((aligned(64)));
static int8_t input1_storage[47] __attribute__((aligned(64)));
static int8_t output0_storage[47] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 47, 1);
  fill_i8(input1_storage, 47, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00602_e9d5725d: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 47));
  return 0;
}
