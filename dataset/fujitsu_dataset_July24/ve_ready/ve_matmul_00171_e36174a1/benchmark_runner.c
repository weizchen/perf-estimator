...
static uint16_t input1_storage[1748992] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1748992, 2);
  fill_f32(input2_storage, 229376, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 3904, 3904, 1, input1_storage, input1_storage, 0, 3904, 448, 448, 1, input2_storage, input2_storage, 0, 512, 448, 448, 1, output0_storage, output0_storage, 0, 512, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00171_e36174a1: benchmark completed");
