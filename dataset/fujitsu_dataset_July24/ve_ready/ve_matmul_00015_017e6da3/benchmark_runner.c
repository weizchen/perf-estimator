...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1536, 3328, 3328, 1, input1_storage, input1_storage, 0, 3328, 512, 512, 1, input2_storage, input2_storage, 0, 1536, 512, 512, 1, output0_storage, output0_storage, 0, 1536, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00015_017e6da3: benchmark completed");
