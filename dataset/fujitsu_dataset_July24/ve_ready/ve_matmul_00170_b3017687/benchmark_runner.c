...
static uint16_t input1_storage[4952064] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 4952064, 2);
  fill_f32(input2_storage, 1523712, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 2496, 2496, 1, input1_storage, input1_storage, 0, 2496, 1984, 1984, 1, input2_storage, input2_storage, 0, 768, 1984, 1984, 1, output0_storage, output0_storage, 0, 768, 1984, 1984, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00170_b3017687: benchmark completed");
