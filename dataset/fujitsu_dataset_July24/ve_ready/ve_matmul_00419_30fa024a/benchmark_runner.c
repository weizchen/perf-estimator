...
static float input1_storage[573440] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 573440, 2);
  fill_f32(input2_storage, 286720, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 640, 640, 1, input1_storage, input1_storage, 0, 640, 896, 896, 1, input2_storage, input2_storage, 0, 320, 896, 896, 1, output0_storage, output0_storage, 0, 320, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00419_30fa024a: benchmark completed");
