...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 640, 640, 1, input1_storage, input1_storage, 0, 640, 576, 576, 1, input2_storage, input2_storage, 0, 704, 576, 576, 1, output0_storage, output0_storage, 0, 704, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00289_f0d81725: benchmark completed");
