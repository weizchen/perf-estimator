...
static float input0_storage[106496] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 106496, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 64, 64, 1, input2_storage, input2_storage, 0, 64, 64, 64, 1, output0_storage, output0_storage, 0, 64, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00436_3c91a9e7: benchmark completed");
