...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 1024, 1024, 1, input2_storage, input2_storage, 0, 768, 1024, 1024, 1, output0_storage, output0_storage, 0, 768, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00036_0cd5693a: benchmark completed");
