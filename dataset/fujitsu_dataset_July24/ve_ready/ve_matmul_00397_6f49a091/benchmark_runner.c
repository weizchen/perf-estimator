...
int main(void) {
  ...
  fill_bf16(input1_storage, 262144, 2);
  fill_f32(input2_storage, 40960, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 128, 128, 1, input2_storage, input2_storage, 0, 320, 128, 128, 1, output0_storage, output0_storage, 0, 320, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00397_6f49a091: benchmark completed");
