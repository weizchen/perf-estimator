...
static uint16_t input1_storage[331776] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 331776, 2);
  fill_f32(input2_storage, 1548288, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 896, 192, 192, 1, input1_storage, input1_storage, 0, 192, 1728, 1728, 1, input2_storage, input2_storage, 0, 896, 1728, 1728, 1, output0_storage, output0_storage, 0, 896, 1728, 1728, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00107_2c3f68b6: benchmark completed");
