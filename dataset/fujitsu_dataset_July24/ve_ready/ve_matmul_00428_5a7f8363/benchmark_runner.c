...
static float input0_storage[3620864] __attribute__((aligned(64)));
static float input1_storage[1384448] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 3620864, 1);
  fill_f32(input1_storage, 1384448, 2);
  fill_f32(input2_storage, 1810432, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2176, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 832, 832, 1, input2_storage, input2_storage, 0, 2176, 832, 832, 1, output0_storage, output0_storage, 0, 2176, 832, 832, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00428_5a7f8363: benchmark completed");
