...
int main(void) {
  fill_bf16(input0_storage, 655360, 1);
  fill_bf16(input1_storage, 655360, 2);
  fill_f32(input2_storage, 262144, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 512, 512, 1, input2_storage, input2_storage, 0, 512, 512, 512, 1, output0_storage, output0_storage, 0, 512, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00306_f7c35684: benchmark completed");
