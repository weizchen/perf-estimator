...
static uint16_t input0_storage[2252800] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 2252800, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1408, 1600, 1600, 1, input1_storage, input1_storage, 0, 1600, 512, 512, 1, input2_storage, input2_storage, 0, 1408, 512, 512, 1, output0_storage, output0_storage, 0, 1408, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00282_a2d92bc7: benchmark completed");
