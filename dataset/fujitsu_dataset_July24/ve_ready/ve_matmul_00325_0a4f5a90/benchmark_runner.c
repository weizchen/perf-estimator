...
int main(void) {
  fill_bf16(input0_storage, 393216, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1536, 256, 256, 1, input1_storage, input1_storage, 0, 256, 512, 512, 1, input2_storage, input2_storage, 0, 1536, 512, 512, 1, output0_storage, output0_storage, 0, 1536, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00325_0a4f5a90: benchmark completed");
