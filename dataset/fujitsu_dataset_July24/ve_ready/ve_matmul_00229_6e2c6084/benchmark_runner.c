...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2176, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 320, 320, 1, input2_storage, input2_storage, 0, 2176, 320, 320, 1, output0_storage, output0_storage, 0, 2176, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00229_6e2c6084: benchmark completed");
