...
static uint16_t input0_storage[233472] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 233472, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 192, 1216, 1216, 1, input1_storage, input1_storage, 0, 1216, 2432, 2432, 1, input2_storage, input2_storage, 0, 192, 2432, 2432, 1, output0_storage, output0_storage, 0, 192, 2432, 2432, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00183_2f09a966: benchmark completed");
