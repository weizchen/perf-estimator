...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 384, 384, 1, input2_storage, input2_storage, 0, 512, 384, 384, 1, output0_storage, output0_storage, 0, 512, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00186_65f61401: benchmark completed");
