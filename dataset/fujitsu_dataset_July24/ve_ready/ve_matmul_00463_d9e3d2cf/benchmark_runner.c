...
static float input0_storage[69632] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 69632, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1088, 64, 64, 1, input1_storage, input1_storage, 0, 64, 384, 384, 1, input2_storage, input2_storage, 0, 1088, 384, 384, 1, output0_storage, output0_storage, 0, 1088, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00463_d9e3d2cf: benchmark completed");
