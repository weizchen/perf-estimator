...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 896, 896, 1, input1_storage, input1_storage, 0, 896, 256, 256, 1, input2_storage, input2_storage, 0, 1280, 256, 256, 1, output0_storage, output0_storage, 0, 1280, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00052_4a0de159: benchmark completed");
