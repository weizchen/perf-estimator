...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 2624, 2624, 1, input1_storage, input1_storage, 0, 2624, 128, 128, 1, input2_storage, input2_storage, 0, 192, 128, 128, 1, output0_storage, output0_storage, 0, 192, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00113_8b9ba5d8: benchmark completed");
