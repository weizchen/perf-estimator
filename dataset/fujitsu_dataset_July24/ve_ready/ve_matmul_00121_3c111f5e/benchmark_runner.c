...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 448, 320, 320, 1, input1_storage, input1_storage, 0, 320, 256, 256, 1, input2_storage, input2_storage, 0, 448, 256, 256, 1, output0_storage, output0_storage, 0, 448, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00121_3c111f5e: benchmark completed");
