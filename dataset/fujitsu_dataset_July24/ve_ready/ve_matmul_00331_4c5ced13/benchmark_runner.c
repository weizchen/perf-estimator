...
int main(void) {
  fill_bf16(input0_storage, 81920, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 640, 640, 1, input1_storage, input1_storage, 0, 640, 768, 768, 1, input2_storage, input2_storage, 0, 128, 768, 768, 1, output0_storage, output0_storage, 0, 128, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00331_4c5ced13: benchmark completed");
