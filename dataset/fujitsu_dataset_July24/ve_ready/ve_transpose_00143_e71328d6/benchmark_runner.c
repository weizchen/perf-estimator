...
int main(void) {
  fill_bf16(input0_storage, 1560, 1);
  fill_bf16(input1_storage, 1560, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 4, 6, 13, 5, 390, 65, 5, 1, input1_storage, input1_storage, 0, 4, 6, 5, 13, 390, 65, 13, 1, output0_storage, output0_storage, 0, 4, 6, 5, 13, 390, 65, 13, 1);
  ofa_dma_memory_fence();
  puts("ve_transpose_00143_e71328d6: benchmark completed");
