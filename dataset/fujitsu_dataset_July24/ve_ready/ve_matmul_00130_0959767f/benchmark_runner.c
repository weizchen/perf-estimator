...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 448, 192, 192, 1, input1_storage, input1_storage, 0, 192, 384, 384, 1, input2_storage, input2_storage, 0, 448, 384, 384, 1, output0_storage, output0_storage, 0, 448, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00130_0959767f: benchmark completed");
