...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 2560, 2560, 1, input1_storage, input1_storage, 0, 2560, 256, 256, 1, input2_storage, input2_storage, 0, 768, 256, 256, 1, output0_storage, output0_storage, 0, 768, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00027_d0e75d2f: benchmark completed");
