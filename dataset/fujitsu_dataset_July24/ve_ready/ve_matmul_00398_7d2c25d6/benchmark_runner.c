...
int main(void) {
  fill_bf16(input0_storage, 163840, 1);
  fill_bf16(input1_storage, 32768, 2);
  fill_f32(input2_storage, 327680, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1280, 128, 128, 1, input1_storage, input1_storage, 0, 128, 256, 256, 1, input2_storage, input2_storage, 0, 1280, 256, 256, 1, output0_storage, output0_storage, 0, 1280, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00398_7d2c25d6: benchmark completed");
