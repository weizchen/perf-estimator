...
int main(void) {
  fill_bf16(input0_storage, 368640, 1);
  fill_bf16(input1_storage, 184320, 2);
  fill_f32(input2_storage, 204800, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 576, 576, 1, input1_storage, input1_storage, 0, 576, 320, 320, 1, input2_storage, input2_storage, 0, 640, 320, 320, 1, output0_storage, output0_storage, 0, 640, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00360_7f01383b: benchmark completed");
