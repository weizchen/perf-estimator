...
static float input0_storage[1835008] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1835008, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1024, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 192, 192, 1, input2_storage, input2_storage, 0, 1024, 192, 192, 1, output0_storage, output0_storage, 0, 1024, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00406_7e82aad4: benchmark completed");
