...
static float input0_storage[126] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 126, 1);
  fill_f32(input1_storage, 126, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 126, 1, input1_storage, input1_storage, 0, 126, 1, output0_storage, output0_storage, 0, 126, 1);
  ofa_dma_memory_fence();
  puts("ve_generic_00710_149f0e88: benchmark completed");
