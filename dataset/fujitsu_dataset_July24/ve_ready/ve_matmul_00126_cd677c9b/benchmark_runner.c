...
static uint16_t input0_storage[266240] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 266240, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 320, 832, 832, 1, input1_storage, input1_storage, 0, 832, 192, 192, 1, input2_storage, input2_storage, 0, 320, 192, 192, 1, output0_storage, output0_storage, 0, 320, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00126_cd677c9b: benchmark completed");
