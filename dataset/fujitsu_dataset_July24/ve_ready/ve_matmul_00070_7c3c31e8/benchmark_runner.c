...
static int8_t input1_storage[7372800] __attribute__((aligned(64)));
static int32_t input2_storage[4096000] __attribute__((aligned(64)));
static int32_t output0_storage[4096000] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 7372800, 2);
  fill_i32(input2_storage, 4096000, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1280, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 3200, 3200, 1, input2_storage, input2_storage, 0, 1280, 3200, 3200, 1, output0_storage, output0_storage, 0, 1280, 3200, 3200, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00070_7c3c31e8: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 4096000));
  return 0;
}
