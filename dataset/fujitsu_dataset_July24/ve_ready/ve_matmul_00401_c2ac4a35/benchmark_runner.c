...
static float input0_storage[2048000] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2048000, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1600, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 128, 128, 1, input2_storage, input2_storage, 0, 1600, 128, 128, 1, output0_storage, output0_storage, 0, 1600, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00401_c2ac4a35: benchmark completed");
