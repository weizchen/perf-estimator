...
static int16_t input0_storage[238] __attribute__((aligned(64)));
static int16_t input1_storage[238] __attribute__((aligned(64)));
static int16_t output0_storage[238] __attribute__((aligned(64)));
...
int main(void) {
  fill_i16(input0_storage, 238, 1);
  fill_i16(input1_storage, 238, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_copy_00015_e367eb95: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 238));
  return 0;
}
