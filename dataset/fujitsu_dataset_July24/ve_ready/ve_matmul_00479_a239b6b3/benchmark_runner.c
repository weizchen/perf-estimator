...
static float input0_storage[1572864] __attribute__((aligned(64)));
static float input1_storage[7077888] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1572864, 1);
  fill_f32(input1_storage, 7077888, 2);
  fill_f32(input2_storage, 663552, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 4096, 4096, 1, input1_storage, input1_storage, 0, 4096, 1728, 1728, 1, input2_storage, input2_storage, 0, 384, 1728, 1728, 1, output0_storage, output0_storage, 0, 384, 1728, 1728, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00479_a239b6b3: benchmark completed");
