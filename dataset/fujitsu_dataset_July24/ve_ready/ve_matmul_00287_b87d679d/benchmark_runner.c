...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 256, 256, 1, input1_storage, input1_storage, 0, 256, 2560, 2560, 1, input2_storage, input2_storage, 0, 128, 2560, 2560, 1, output0_storage, output0_storage, 0, 128, 2560, 2560, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00287_b87d679d: benchmark completed");
