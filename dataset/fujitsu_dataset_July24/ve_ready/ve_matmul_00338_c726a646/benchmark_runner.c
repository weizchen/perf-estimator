...
int main(void) {
  fill_bf16(input0_storage, 294912, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 960, 960, 1, input2_storage, input2_storage, 0, 256, 960, 960, 1, output0_storage, output0_storage, 0, 256, 960, 960, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00338_c726a646: benchmark completed");
