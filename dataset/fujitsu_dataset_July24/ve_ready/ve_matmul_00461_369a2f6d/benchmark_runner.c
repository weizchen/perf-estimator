...
static float input0_storage[253952] __attribute__((aligned(64)));
static float input1_storage[1142784] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 253952, 1);
  fill_f32(input1_storage, 1142784, 2);
  fill_f32(input2_storage, 73728, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1984, 1984, 1, input1_storage, input1_storage, 0, 1984, 576, 576, 1, input2_storage, input2_storage, 0, 128, 576, 576, 1, output0_storage, output0_storage, 0, 128, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00461_369a2f6d: benchmark completed");
