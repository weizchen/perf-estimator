...
int main(void) {
  fill_bf16(input0_storage, 61440, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 320, 192, 192, 1, input1_storage, input1_storage, 0, 192, 1920, 1920, 1, input2_storage, input2_storage, 0, 320, 1920, 1920, 1, output0_storage, output0_storage, 0, 320, 1920, 1920, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00391_24037afd: benchmark completed");
