...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 960, 960, 1, input2_storage, input2_storage, 0, 64, 960, 960, 1, output0_storage, output0_storage, 0, 64, 960, 960, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00274_2cf9413c: benchmark completed");
