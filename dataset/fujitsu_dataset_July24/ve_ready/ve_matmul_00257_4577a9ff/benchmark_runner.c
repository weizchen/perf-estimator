...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1920, 960, 960, 1, input1_storage, input1_storage, 0, 960, 256, 256, 1, input2_storage, input2_storage, 0, 1920, 256, 256, 1, output0_storage, output0_storage, 0, 1920, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00257_4577a9ff: benchmark completed");
