...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 640, 640, 1, input2_storage, input2_storage, 0, 384, 640, 640, 1, output0_storage, output0_storage, 0, 384, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00045_eceebb1a: benchmark completed");
