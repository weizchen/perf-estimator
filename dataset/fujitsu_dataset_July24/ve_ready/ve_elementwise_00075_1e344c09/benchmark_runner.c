...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 1, input1_storage, input1_storage, 0, 64, 1, output0_storage, output0_storage, 0, 64, 1);
  ofa_dma_memory_fence();
  puts("ve_elementwise_00075_1e344c09: benchmark completed");
