...
static float input0_storage[835584] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 835584, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2176, 384, 384, 1, input1_storage, input1_storage, 0, 384, 512, 512, 1, input2_storage, input2_storage, 0, 2176, 512, 512, 1, output0_storage, output0_storage, 0, 2176, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00483_3099b35f: benchmark completed");
