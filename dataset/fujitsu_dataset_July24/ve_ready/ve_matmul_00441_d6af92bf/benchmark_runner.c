...
static float input0_storage[540672] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 540672, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 2112, 2112, 1, input1_storage, input1_storage, 0, 2112, 192, 192, 1, input2_storage, input2_storage, 0, 256, 192, 192, 1, output0_storage, output0_storage, 0, 256, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00441_d6af92bf: benchmark completed");
