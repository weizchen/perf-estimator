...
int main(void) {
  fill_f16(input0_storage, 1310720, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 192, 192, 1, input2_storage, input2_storage, 0, 1280, 192, 192, 1, output0_storage, output0_storage, 0, 1280, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00118_187153f2: benchmark completed");
