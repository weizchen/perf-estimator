...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 896, 768, 768, 1, input1_storage, input1_storage, 0, 768, 2048, 2048, 1, input2_storage, input2_storage, 0, 896, 2048, 2048, 1, output0_storage, output0_storage, 0, 896, 2048, 2048, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00154_9cc36e36: benchmark completed");
