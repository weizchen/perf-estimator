...
static float input0_storage[208896] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 208896, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3264, 64, 64, 1, input1_storage, input1_storage, 0, 64, 320, 320, 1, input2_storage, input2_storage, 0, 3264, 320, 320, 1, output0_storage, output0_storage, 0, 3264, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00408_58fd8067: benchmark completed");
