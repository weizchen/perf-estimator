...
static float input1_storage[720] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 720, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 36, 20, 20, 1, input1_storage, input1_storage, 0, 20, 36, 36, 1, output0_storage, output0_storage, 0, 20, 36, 36, 1);
  ofa_dma_memory_fence();
  puts("ve_transpose_00134_5280a6ef: benchmark completed");
