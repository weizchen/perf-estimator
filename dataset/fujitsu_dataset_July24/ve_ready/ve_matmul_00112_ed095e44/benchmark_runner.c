...
static uint16_t input1_storage[1507328] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1507328, 2);
  fill_f32(input2_storage, 376832, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 512, 512, 1, input1_storage, input1_storage, 0, 512, 2944, 2944, 1, input2_storage, input2_storage, 0, 128, 2944, 2944, 1, output0_storage, output0_storage, 0, 128, 2944, 2944, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00112_ed095e44: benchmark completed");
