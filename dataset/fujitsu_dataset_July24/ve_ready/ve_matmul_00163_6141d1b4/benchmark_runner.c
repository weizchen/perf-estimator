...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 3648, 128, 128, 1, input1_storage, input1_storage, 0, 128, 512, 512, 1, input2_storage, input2_storage, 0, 3648, 512, 512, 1, output0_storage, output0_storage, 0, 3648, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00163_6141d1b4: benchmark completed");
