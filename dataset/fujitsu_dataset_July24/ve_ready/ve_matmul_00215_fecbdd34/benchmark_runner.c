...
static uint16_t input1_storage[860160] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 860160, 2);
  fill_f16(input2_storage, 86016, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 448, 448, 1, input2_storage, input2_storage, 0, 192, 448, 448, 1, output0_storage, output0_storage, 0, 192, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00215_fecbdd34: benchmark completed");
