...
int main(void) {
  fill_bf16(input0_storage, 356352, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1856, 192, 192, 1, input1_storage, input1_storage, 0, 192, 640, 640, 1, input2_storage, input2_storage, 0, 1856, 640, 640, 1, output0_storage, output0_storage, 0, 1856, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00386_4c52e914: benchmark completed");
