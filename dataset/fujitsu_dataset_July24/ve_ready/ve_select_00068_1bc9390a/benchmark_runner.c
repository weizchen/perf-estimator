...
int main(void) {
  fill_i1(input0_storage, 2728, 1);
  fill_i16(input1_storage, 2728, 2);
  fill_i16(input2_storage, 2728, 3);
  fill_i16(input3_storage, 2728, 4);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 88, 31, 31, 1, input1_storage, input1_storage, 0, 88, 31, 31, 1, input2_storage, input2_storage, 0, 88, 31, 31, 1, input3_storage, input3_storage, 0, 88, 31, 31, 1, output0_storage, output0_storage, 0, 88, 31, 31, 1);
  ofa_dma_memory_fence();
  puts("ve_select_00068_1bc9390a: benchmark completed");
