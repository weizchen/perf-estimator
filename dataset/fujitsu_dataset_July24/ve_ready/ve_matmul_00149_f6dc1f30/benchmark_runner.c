...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 128, 128, 1, input1_storage, input1_storage, 0, 128, 2816, 2816, 1, input2_storage, input2_storage, 0, 256, 2816, 2816, 1, output0_storage, output0_storage, 0, 256, 2816, 2816, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00149_f6dc1f30: benchmark completed");
