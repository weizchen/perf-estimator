...
static uint16_t input0_storage[420] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 420, 1);
  fill_bf16(input1_storage, 420, 2);
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00179_39b29206: benchmark completed");
