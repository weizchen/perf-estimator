...
static uint16_t input0_storage[999424] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 999424, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3904, 256, 256, 1, input1_storage, input1_storage, 0, 256, 128, 128, 1, input2_storage, input2_storage, 0, 3904, 128, 128, 1, output0_storage, output0_storage, 0, 3904, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00173_b6652cbc: benchmark completed");
