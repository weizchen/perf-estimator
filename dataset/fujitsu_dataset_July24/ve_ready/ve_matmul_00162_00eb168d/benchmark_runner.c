...
static uint16_t input1_storage[5406720] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 5406720, 2);
  fill_f32(input2_storage, 983040, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 3520, 3520, 1, input1_storage, input1_storage, 0, 3520, 1536, 1536, 1, input2_storage, input2_storage, 0, 640, 1536, 1536, 1, output0_storage, output0_storage, 0, 640, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00162_00eb168d: benchmark completed");
