...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2304, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 384, 384, 1, input2_storage, input2_storage, 0, 2304, 384, 384, 1, output0_storage, output0_storage, 0, 2304, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00016_2c6c2aef: benchmark completed");
