...
static float input0_storage[688128] __attribute__((aligned(64)));
static float input1_storage[2293760] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 688128, 1);
  fill_f32(input1_storage, 2293760, 2);
  fill_f32(input2_storage, 122880, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 640, 640, 1, input2_storage, input2_storage, 0, 192, 640, 640, 1, output0_storage, output0_storage, 0, 192, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00490_be1050e2: benchmark completed");
