...
static uint16_t input0_storage[3211264] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 3211264, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 896, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 896, 896, 1, input2_storage, input2_storage, 0, 896, 896, 896, 1, output0_storage, output0_storage, 0, 896, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00230_8a4f9177: benchmark completed");
