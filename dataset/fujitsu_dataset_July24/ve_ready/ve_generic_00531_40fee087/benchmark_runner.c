...
static int8_t input1_storage[20] __attribute__((aligned(64)));
static int8_t output0_storage[20] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("ve_generic_00531_40fee087: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 20));
  return 0;
}
