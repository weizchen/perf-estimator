...
static uint16_t input1_storage[720896] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_bf16(input1_storage, 720896, 2);
  fill_f32(input2_storage, 270336, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1408, 1408, 1, input2_storage, input2_storage, 0, 192, 1408, 1408, 1, output0_storage, output0_storage, 0, 192, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00304_9cb16ea2: benchmark completed");
