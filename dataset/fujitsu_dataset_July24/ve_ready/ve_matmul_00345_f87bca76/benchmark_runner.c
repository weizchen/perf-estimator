...
int main(void) {
  fill_bf16(input0_storage, 4096, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 64, 64, 1, input1_storage, input1_storage, 0, 64, 256, 256, 1, input2_storage, input2_storage, 0, 64, 256, 256, 1, output0_storage, output0_storage, 0, 64, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00345_f87bca76: benchmark completed");
