...
int main(void) {
  fill_bf16(input0_storage, 745472, 1);
  fill_bf16(input1_storage, 1277952, 2);
  fill_f32(input2_storage, 344064, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 448, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 768, 768, 1, input2_storage, input2_storage, 0, 448, 768, 768, 1, output0_storage, output0_storage, 0, 448, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00378_4a2c1838: benchmark completed");
