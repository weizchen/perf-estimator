...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1856, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1408, 1408, 1, input2_storage, input2_storage, 0, 1856, 1408, 1408, 1, output0_storage, output0_storage, 0, 1856, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("ve_matmul_00161_43f657f8: benchmark completed");
