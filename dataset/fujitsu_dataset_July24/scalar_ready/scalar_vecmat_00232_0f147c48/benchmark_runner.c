...
static uint16_t input0_storage[1280] __attribute__((aligned(64)));
static uint16_t input1_storage[737280] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 1280, 1);
  fill_f16(input1_storage, 737280, 2);
  fill_f32(input2_storage, 576, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1280, 1, input1_storage, input1_storage, 0, 1280, 576, 576, 1, input2_storage, input2_storage, 0, 576, 1, output0_storage, output0_storage, 0, 576, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00232_0f147c48: benchmark completed");
