...
static uint16_t input1_storage[389120] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 389120, 2);
  fill_f16(input2_storage, 61440, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 1216, 1216, 1, input1_storage, input1_storage, 0, 1216, 320, 320, 1, input2_storage, input2_storage, 0, 192, 320, 320, 1, output0_storage, output0_storage, 0, 192, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00275_c066d7d0: benchmark completed");
