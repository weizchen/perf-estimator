...
static float input0_storage[278528] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 278528, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1088, 256, 256, 1, input1_storage, input1_storage, 0, 256, 1, input2_storage, input2_storage, 0, 1088, 1, output0_storage, output0_storage, 0, 1088, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00195_28ba8061: benchmark completed");
