...
static int8_t input0_storage[376] __attribute__((aligned(64)));
static int8_t input1_storage[376] __attribute__((aligned(64)));
static int8_t output0_storage[376] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 376, 1);
  fill_i8(input1_storage, 376, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00578_0023bce6: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 376));
  return 0;
}
