...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 118, 8, 8, 1, input1_storage, input1_storage, 0, 8, 1, output0_storage, output0_storage, 0, 8, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00032_acf273db: benchmark completed");
