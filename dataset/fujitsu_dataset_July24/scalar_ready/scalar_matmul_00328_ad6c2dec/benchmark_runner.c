...
static float input0_storage[188416] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 188416, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2944, 64, 64, 1, input1_storage, input1_storage, 0, 64, 128, 128, 1, input2_storage, input2_storage, 0, 2944, 128, 128, 1, output0_storage, output0_storage, 0, 2944, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00328_ad6c2dec: benchmark completed");
