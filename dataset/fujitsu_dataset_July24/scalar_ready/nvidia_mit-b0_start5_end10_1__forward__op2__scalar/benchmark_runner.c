...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 32, 32, 32, 1, input1_storage, input1_storage, 0, 1, 32, 32, 1024, 32, 1, output0_storage, output0_storage, 0, 1, 32, 32, 1024, 32, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start5_end10_1__forward__op2__scalar: benchmark completed");
