...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 12, 64, 64, 49152, 4096, 64, 1, input1_storage, input1_storage, 0, 1, 12, 64, 64, 49152, 4096, 64, 1, output0_storage, output0_storage, 0, 1, 12, 64, 64, 49152, 4096, 64, 1);
  ofa_dma_memory_fence();
  puts("Aleksandar_electra-srb-ner-setimes_start18_end22_4__forward__op7__scalar: benchmark completed");
