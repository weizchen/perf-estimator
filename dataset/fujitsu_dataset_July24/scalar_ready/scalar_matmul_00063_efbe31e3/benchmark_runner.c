...
static int8_t input1_storage[1048576] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 1048576, 2);
  fill_i32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 512, 512, 1, input2_storage, input2_storage, 0, 128, 512, 512, 1, output0_storage, output0_storage, 0, 128, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00063_efbe31e3: benchmark completed");
