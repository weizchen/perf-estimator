...
static int16_t input1_storage[40] __attribute__((aligned(64)));
static int16_t output0_storage[40] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("scalar_copy_00040_9640a0ba: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 40));
  return 0;
}
