...
static int8_t input0_storage[7203] __attribute__((aligned(64)));
static int8_t input1_storage[174] __attribute__((aligned(64)));
static int32_t input2_storage[139258] __attribute__((aligned(64)));
static int32_t output0_storage[139258] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 7203, 1);
  fill_i8(input1_storage, 174, 2);
  fill_i32(input2_storage, 139258, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 49, 49, 3, 7203, 147, 3, 1, input1_storage, input1_storage, 0, 1, 1, 3, 58, 174, 174, 58, 1, input2_storage, input2_storage, 0, 1, 49, 49, 58, 139258, 2842, 58, 1, output0_storage, output0_storage, 0, 1, 49, 49, 58, 139258, 2842, 58, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00041_fb26d50c: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 139258));
  return 0;
}
