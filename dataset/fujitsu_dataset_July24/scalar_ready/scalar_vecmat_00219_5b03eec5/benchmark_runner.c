...
static int8_t input0_storage[640] __attribute__((aligned(64)));
...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 1, input1_storage, input1_storage, 0, 640, 512, 512, 1, input2_storage, input2_storage, 0, 512, 1, output0_storage, output0_storage, 0, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00219_5b03eec5: benchmark completed");
