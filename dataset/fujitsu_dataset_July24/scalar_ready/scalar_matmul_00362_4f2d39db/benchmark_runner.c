...
static float input0_storage[2359296] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2359296, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 128, 128, 1, input2_storage, input2_storage, 0, 1152, 128, 128, 1, output0_storage, output0_storage, 0, 1152, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00362_4f2d39db: benchmark completed");
