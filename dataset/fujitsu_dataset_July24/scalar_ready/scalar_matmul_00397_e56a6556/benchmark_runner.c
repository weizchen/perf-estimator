...
static float input0_storage[1187840] __attribute__((aligned(64)));
static float input1_storage[3563520] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1187840, 1);
  fill_f32(input1_storage, 3563520, 2);
  fill_f32(input2_storage, 307200, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 3712, 3712, 1, input1_storage, input1_storage, 0, 3712, 960, 960, 1, input2_storage, input2_storage, 0, 320, 960, 960, 1, output0_storage, output0_storage, 0, 320, 960, 960, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00397_e56a6556: benchmark completed");
