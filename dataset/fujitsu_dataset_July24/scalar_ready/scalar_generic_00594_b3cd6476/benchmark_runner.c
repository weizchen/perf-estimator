...
static int8_t input0_storage[32] __attribute__((aligned(64)));
static int8_t input1_storage[32] __attribute__((aligned(64)));
static int8_t output0_storage[32] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00594_b3cd6476: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 32));
  return 0;
}
