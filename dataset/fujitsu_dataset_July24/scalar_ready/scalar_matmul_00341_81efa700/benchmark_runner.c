...
static float input0_storage[36864] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 36864, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 576, 64, 64, 1, input1_storage, input1_storage, 0, 64, 3072, 3072, 1, input2_storage, input2_storage, 0, 576, 3072, 3072, 1, output0_storage, output0_storage, 0, 576, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00341_81efa700: benchmark completed");
