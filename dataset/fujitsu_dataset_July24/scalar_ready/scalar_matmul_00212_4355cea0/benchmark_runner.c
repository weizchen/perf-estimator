...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 192, 192, 1, input2_storage, input2_storage, 0, 768, 192, 192, 1, output0_storage, output0_storage, 0, 768, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00212_4355cea0: benchmark completed");
