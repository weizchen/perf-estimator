...
static uint16_t input0_storage[52] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 52, 1);
  fill_f16(input1_storage, 52, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00224_95ac11e3: benchmark completed");
