...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1, input2_storage, input2_storage, 0, 192, 1, output0_storage, output0_storage, 0, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00125_5513bb25: benchmark completed");
