...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 1024, 5, 64, 327680, 320, 64, 1, input1_storage, input1_storage, 0, 1, 5, 1024, 64, 327680, 65536, 64, 1, output0_storage, output0_storage, 0, 1, 5, 1024, 64, 327680, 65536, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start381_end386_41__forward__op6__scalar: benchmark completed");
