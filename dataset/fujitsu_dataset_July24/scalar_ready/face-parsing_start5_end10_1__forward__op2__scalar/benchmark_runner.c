...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 64, 64, 1, input1_storage, input1_storage, 0, 1, 64, 64, 4096, 64, 1, output0_storage, output0_storage, 0, 1, 64, 64, 4096, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start5_end10_1__forward__op2__scalar: benchmark completed");
