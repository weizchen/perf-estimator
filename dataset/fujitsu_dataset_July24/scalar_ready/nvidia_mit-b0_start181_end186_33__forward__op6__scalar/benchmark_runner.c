...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 1024, 5, 32, 163840, 160, 32, 1, input1_storage, input1_storage, 0, 1, 5, 1024, 32, 163840, 32768, 32, 1, output0_storage, output0_storage, 0, 1, 5, 1024, 32, 163840, 32768, 32, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start181_end186_33__forward__op6__scalar: benchmark completed");
