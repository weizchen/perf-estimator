...
static float input0_storage[369920] __attribute__((aligned(64)));
static float input1_storage[1474560] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 369920, 1);
  fill_f32(input1_storage, 1474560, 2);
  fill_f32(input2_storage, 131072, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 320, 34, 34, 369920, 1156, 34, 1, input1_storage, input1_storage, 0, 512, 320, 3, 3, 2880, 9, 3, 1, input2_storage, input2_storage, 0, 1, 512, 16, 16, 131072, 256, 16, 1, output0_storage, output0_storage, 0, 1, 512, 16, 16, 131072, 256, 16, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start1984_end1989_60__forward__op1__scalar: benchmark completed");
