...
static int8_t input1_storage[68] __attribute__((aligned(64)));
static int8_t output0_storage[68] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 68, 1);
  fill_i8(input1_storage, 68, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00549_e3bfa458: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 68));
  return 0;
}
