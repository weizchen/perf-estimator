...
static int8_t input0_storage[1146880] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1146880, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 512, 512, 1, input2_storage, input2_storage, 0, 640, 512, 512, 1, output0_storage, output0_storage, 0, 640, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00073_9ddbdca0: benchmark completed");
