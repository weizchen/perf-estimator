...
static uint16_t input0_storage[77824] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 77824, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1216, 64, 64, 1, input1_storage, input1_storage, 0, 64, 256, 256, 1, input2_storage, input2_storage, 0, 1216, 256, 256, 1, output0_storage, output0_storage, 0, 1216, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00297_98c85072: benchmark completed");
