...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 272, 1, input1_storage, input1_storage, 0, 272, 1, output0_storage, output0_storage, 0, 272, 1);
  ofa_dma_memory_fence();
  puts("scalar_copy_00139_9fd20dbd: benchmark completed");
