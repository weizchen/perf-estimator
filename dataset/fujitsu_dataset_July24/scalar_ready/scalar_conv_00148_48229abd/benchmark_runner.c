...
static uint16_t input1_storage[25] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 25, 2);
  fill_f32(input2_storage, 144, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 27, 27, 1, 729, 27, 1, 1, input1_storage, input1_storage, 0, 5, 5, 1, 1, 5, 1, 1, 1, input2_storage, input2_storage, 0, 1, 12, 12, 1, 144, 12, 1, 1, output0_storage, output0_storage, 0, 1, 12, 12, 1, 144, 12, 1, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00148_48229abd: benchmark completed");
