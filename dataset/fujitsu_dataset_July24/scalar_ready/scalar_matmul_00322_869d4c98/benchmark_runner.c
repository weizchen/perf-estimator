...
static float input0_storage[335872] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 335872, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2624, 128, 128, 1, input1_storage, input1_storage, 0, 128, 384, 384, 1, input2_storage, input2_storage, 0, 2624, 384, 384, 1, output0_storage, output0_storage, 0, 2624, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00322_869d4c98: benchmark completed");
