...
static uint16_t input1_storage[24] __attribute__((aligned(64)));
static uint16_t output0_storage[24] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00258_9166a586: benchmark completed");
  printf("output0_f16bits_checksum=%lld\n", checksum_u16(output0_storage, 24));
  return 0;
}
