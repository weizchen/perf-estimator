...
static float input0_storage[2916] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2916, 1);
  fill_f32(input1_storage, 36, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 81, 36, 36, 1, input1_storage, input1_storage, 0, 36, 1, output0_storage, output0_storage, 0, 36, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00174_190258f9: benchmark completed");
