...
static int8_t input0_storage[5963776] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 5963776, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3584, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 512, 512, 1, input2_storage, input2_storage, 0, 3584, 512, 512, 1, output0_storage, output0_storage, 0, 3584, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00061_8127879d: benchmark completed");
