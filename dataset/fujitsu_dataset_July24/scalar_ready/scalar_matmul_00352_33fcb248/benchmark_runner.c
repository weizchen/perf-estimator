...
static float input0_storage[851968] __attribute__((aligned(64)));
static float input1_storage[1011712] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 851968, 1);
  fill_f32(input1_storage, 1011712, 2);
  fill_f32(input2_storage, 1245184, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1024, 832, 832, 1, input1_storage, input1_storage, 0, 832, 1216, 1216, 1, input2_storage, input2_storage, 0, 1024, 1216, 1216, 1, output0_storage, output0_storage, 0, 1024, 1216, 1216, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00352_33fcb248: benchmark completed");
