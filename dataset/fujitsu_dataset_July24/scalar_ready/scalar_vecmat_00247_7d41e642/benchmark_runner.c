...
static uint16_t input0_storage[896] __attribute__((aligned(64)));
static uint16_t input1_storage[688128] __attribute__((aligned(64)));
static float input2_storage[768] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 896, 1);
  fill_f16(input1_storage, 688128, 2);
  fill_f32(input2_storage, 768, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 896, 1, input1_storage, input1_storage, 0, 896, 768, 768, 1, input2_storage, input2_storage, 0, 768, 1, output0_storage, output0_storage, 0, 768, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00247_7d41e642: benchmark completed");
