...
static float input0_storage[53248] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 53248, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 832, 832, 1, input1_storage, input1_storage, 0, 832, 3520, 3520, 1, input2_storage, input2_storage, 0, 64, 3520, 3520, 1, output0_storage, output0_storage, 0, 64, 3520, 3520, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00337_29f5e8ed: benchmark completed");
