...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 256, 512, 131072, 512, 1, input1_storage, input1_storage, 0, 1, 256, 1, 256, 1, 1, output0_storage, output0_storage, 0, 1, 256, 1, 256, 1, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start1984_end1989_60__forward__op17__scalar: benchmark completed");
