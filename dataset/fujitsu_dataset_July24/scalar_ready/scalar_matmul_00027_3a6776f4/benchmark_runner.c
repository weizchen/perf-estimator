...
static int8_t input1_storage[3342336] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 3342336, 2);
  fill_i32(input2_storage, 196608, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 1536, 1536, 1, input2_storage, input2_storage, 0, 128, 1536, 1536, 1, output0_storage, output0_storage, 0, 128, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00027_3a6776f4: benchmark completed");
