...
static uint16_t input0_storage[704] __attribute__((aligned(64)));
...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 1, input1_storage, input1_storage, 0, 704, 256, 256, 1, input2_storage, input2_storage, 0, 256, 1, output0_storage, output0_storage, 0, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00239_9b5f8993: benchmark completed");
