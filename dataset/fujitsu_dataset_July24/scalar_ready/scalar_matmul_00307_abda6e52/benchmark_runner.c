...
static uint16_t input0_storage[1769472] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 1769472, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2304, 768, 768, 1, input1_storage, input1_storage, 0, 768, 512, 512, 1, input2_storage, input2_storage, 0, 2304, 512, 512, 1, output0_storage, output0_storage, 0, 2304, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00307_abda6e52: benchmark completed");
