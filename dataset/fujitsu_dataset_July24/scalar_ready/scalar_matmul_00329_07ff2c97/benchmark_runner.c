...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 1600, 1600, 1, input1_storage, input1_storage, 0, 1600, 512, 512, 1, input2_storage, input2_storage, 0, 128, 512, 512, 1, output0_storage, output0_storage, 0, 128, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00329_07ff2c97: benchmark completed");
