...
static uint16_t input0_storage[8712] __attribute__((aligned(64)));
static uint16_t input1_storage[1764] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 8712, 1);
  fill_f16(input1_storage, 1764, 2);
  fill_f32(input2_storage, 128, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 22, 22, 18, 8712, 396, 18, 1, input1_storage, input1_storage, 0, 7, 7, 18, 2, 252, 36, 2, 1, input2_storage, input2_storage, 0, 1, 8, 8, 2, 128, 16, 2, 1, output0_storage, output0_storage, 0, 1, 8, 8, 2, 128, 16, 2, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00128_3b4222d6: benchmark completed");
