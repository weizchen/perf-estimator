...
static float input0_storage[8257536] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 8257536, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3072, 2688, 2688, 1, input1_storage, input1_storage, 0, 2688, 128, 128, 1, input2_storage, input2_storage, 0, 3072, 128, 128, 1, output0_storage, output0_storage, 0, 3072, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00404_c4e6f6ad: benchmark completed");
