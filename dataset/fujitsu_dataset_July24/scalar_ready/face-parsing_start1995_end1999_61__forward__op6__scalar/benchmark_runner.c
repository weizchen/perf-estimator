...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 256, 8, 64, 131072, 512, 64, 1, input1_storage, input1_storage, 0, 1, 8, 256, 64, 131072, 16384, 64, 1, output0_storage, output0_storage, 0, 1, 8, 256, 64, 131072, 16384, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start1995_end1999_61__forward__op6__scalar: benchmark completed");
