...
static float input0_storage[90112] __attribute__((aligned(64)));
static float input1_storage[315392] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 90112, 1);
  fill_f32(input1_storage, 315392, 2);
  fill_f32(input2_storage, 57344, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 704, 704, 1, input1_storage, input1_storage, 0, 704, 448, 448, 1, input2_storage, input2_storage, 0, 128, 448, 448, 1, output0_storage, output0_storage, 0, 128, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00323_0aae20f1: benchmark completed");
