...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 4096, 2, 32, 262144, 64, 32, 1, input1_storage, input1_storage, 0, 1, 2, 4096, 32, 262144, 131072, 32, 1, output0_storage, output0_storage, 0, 1, 2, 4096, 32, 262144, 131072, 32, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start134_end138_26__forward__op0__scalar: benchmark completed");
