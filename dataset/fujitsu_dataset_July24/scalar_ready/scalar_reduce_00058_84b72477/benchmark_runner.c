...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 7, 27, 27, 1, input1_storage, input1_storage, 0, 27, 1, output0_storage, output0_storage, 0, 27, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00058_84b72477: benchmark completed");
