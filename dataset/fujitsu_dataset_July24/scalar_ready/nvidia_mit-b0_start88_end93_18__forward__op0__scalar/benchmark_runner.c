...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 1, input1_storage, input1_storage, 0, 1, 64, 64, 64, 262144, 4096, 64, 1, output0_storage, output0_storage, 0, 1, 64, 64, 64, 262144, 4096, 64, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start88_end93_18__forward__op0__scalar: benchmark completed");
