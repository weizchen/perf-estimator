...
int main(void) {
  ...
  fill_f16(input1_storage, 278528, 2);
  fill_f32(input2_storage, 139264, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 128, 128, 1, input1_storage, input1_storage, 0, 128, 2176, 2176, 1, input2_storage, input2_storage, 0, 64, 2176, 2176, 1, output0_storage, output0_storage, 0, 64, 2176, 2176, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00160_512be2f1: benchmark completed");
