...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 320, 1, input1_storage, input1_storage, 0, 1, 320, 32, 32, 327680, 1024, 32, 1, output0_storage, output0_storage, 0, 1, 320, 32, 32, 327680, 1024, 32, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start376_end381_40__forward__op0__scalar: benchmark completed");
