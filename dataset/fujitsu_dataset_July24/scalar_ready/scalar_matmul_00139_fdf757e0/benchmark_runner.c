...
static uint16_t input0_storage[348160] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 348160, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1088, 320, 320, 1, input1_storage, input1_storage, 0, 320, 256, 256, 1, input2_storage, input2_storage, 0, 1088, 256, 256, 1, output0_storage, output0_storage, 0, 1088, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00139_fdf757e0: benchmark completed");
