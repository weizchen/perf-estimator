...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 16, 16, 512, 131072, 8192, 512, 1, input1_storage, input1_storage, 0, 1, 512, 16, 16, 131072, 256, 16, 1, output0_storage, output0_storage, 0, 1, 512, 16, 16, 131072, 256, 16, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start2089_end2096_73__forward__op15__scalar: benchmark completed");
