...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 768, 768, 1, input1_storage, input1_storage, 0, 768, 320, 320, 1, input2_storage, input2_storage, 0, 64, 320, 320, 1, output0_storage, output0_storage, 0, 64, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00294_d6a4e3ba: benchmark completed");
