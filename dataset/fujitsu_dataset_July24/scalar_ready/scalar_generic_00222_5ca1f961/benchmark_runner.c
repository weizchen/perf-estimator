...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 44, 1, input1_storage, input1_storage, 0, 44, 1, output0_storage, output0_storage, 0, 44, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00222_5ca1f961: benchmark completed");
