...
static int8_t input0_storage[1867776] __attribute__((aligned(64)));
static int8_t input1_storage[622592] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1867776, 1);
  fill_i8(input1_storage, 622592, 2);
  fill_i32(input2_storage, 196608, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 2432, 2432, 1, input1_storage, input1_storage, 0, 2432, 256, 256, 1, input2_storage, input2_storage, 0, 768, 256, 256, 1, output0_storage, output0_storage, 0, 768, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00031_18d3d38a: benchmark completed");
