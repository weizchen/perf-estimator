...
static float input0_storage[487424] __attribute__((aligned(64)));
static float input1_storage[86016] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 487424, 1);
  fill_f32(input1_storage, 86016, 2);
  fill_f32(input2_storage, 208896, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1088, 448, 448, 1, input1_storage, input1_storage, 0, 448, 192, 192, 1, input2_storage, input2_storage, 0, 1088, 192, 192, 1, output0_storage, output0_storage, 0, 1088, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00336_1c6531d0: benchmark completed");
