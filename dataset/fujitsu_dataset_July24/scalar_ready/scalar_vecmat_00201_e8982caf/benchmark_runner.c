...
static int8_t input1_storage[540672] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 384, 1);
  fill_i8(input1_storage, 540672, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00201_e8982caf: benchmark completed");
