...
static int8_t input1_storage[98304] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 98304, 2);
  fill_i32(input2_storage, 384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 1, input1_storage, input1_storage, 0, 256, 384, 384, 1, input2_storage, input2_storage, 0, 384, 1, output0_storage, output0_storage, 0, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00203_8f05cf71: benchmark completed");
