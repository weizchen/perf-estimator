...
static uint16_t input1_storage[184320] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 1146880, 1);
  fill_f16(input1_storage, 184320, 2);
  fill_f32(input2_storage, 2064384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 3584, 320, 320, 1, input1_storage, input1_storage, 0, 320, 576, 576, 1, input2_storage, input2_storage, 0, 3584, 576, 576, 1, output0_storage, output0_storage, 0, 3584, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00122_db881a9c: benchmark completed");
