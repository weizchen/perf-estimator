...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 960, 960, 1, input1_storage, input1_storage, 0, 960, 448, 448, 1, input2_storage, input2_storage, 0, 256, 448, 448, 1, output0_storage, output0_storage, 0, 256, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00124_6f279011: benchmark completed");
