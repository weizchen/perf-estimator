...
int main(void) {
  ...
  fill_f16(input1_storage, 700416, 2);
  fill_f16(input2_storage, 442368, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 1216, 1216, 1, input1_storage, input1_storage, 0, 1216, 576, 576, 1, input2_storage, input2_storage, 0, 768, 576, 576, 1, output0_storage, output0_storage, 0, 768, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00226_df4696b3: benchmark completed");
