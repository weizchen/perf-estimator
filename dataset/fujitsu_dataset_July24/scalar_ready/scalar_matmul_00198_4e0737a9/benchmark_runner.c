...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 896, 640, 640, 1, input1_storage, input1_storage, 0, 640, 128, 128, 1, input2_storage, input2_storage, 0, 896, 128, 128, 1, output0_storage, output0_storage, 0, 896, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00198_4e0737a9: benchmark completed");
