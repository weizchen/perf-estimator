...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 30, 1, input1_storage, input1_storage, 0, 30, 1, output0_storage, output0_storage, 0, 30, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00159_c78db245: benchmark completed");
