...
static float input0_storage[2621440] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2621440, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2048, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 128, 128, 1, input2_storage, input2_storage, 0, 2048, 128, 128, 1, output0_storage, output0_storage, 0, 2048, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00351_7d6c12ec: benchmark completed");
