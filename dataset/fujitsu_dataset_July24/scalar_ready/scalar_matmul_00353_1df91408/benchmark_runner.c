...
static float input0_storage[147456] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 147456, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 576, 256, 256, 1, input1_storage, input1_storage, 0, 256, 512, 512, 1, input2_storage, input2_storage, 0, 576, 512, 512, 1, output0_storage, output0_storage, 0, 576, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00353_1df91408: benchmark completed");
