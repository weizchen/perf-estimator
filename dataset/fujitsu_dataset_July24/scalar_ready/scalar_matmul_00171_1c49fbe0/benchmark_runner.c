...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2880, 64, 64, 1, input1_storage, input1_storage, 0, 64, 256, 256, 1, input2_storage, input2_storage, 0, 2880, 256, 256, 1, output0_storage, output0_storage, 0, 2880, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00171_1c49fbe0: benchmark completed");
