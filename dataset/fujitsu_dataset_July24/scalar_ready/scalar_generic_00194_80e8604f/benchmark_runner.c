...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 76, 1, input1_storage, input1_storage, 0, 76, 1, output0_storage, output0_storage, 0, 76, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00194_80e8604f: benchmark completed");
