...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 100, 1, input1_storage, input1_storage, 0, 100, 1, output0_storage, output0_storage, 0, 100, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00523_95d37d03: benchmark completed");
