...
static uint16_t input0_storage[110450] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 110450, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1, 47, 47, 50, 110450, 2350, 50, 1, input1_storage, input1_storage, 0, 1, 1, 50, 3, 150, 150, 3, 1, input2_storage, input2_storage, 0, 1, 24, 24, 3, 1728, 72, 3, 1, output0_storage, output0_storage, 0, 1, 24, 24, 3, 1728, 72, 3, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00073_7b99d8d3: benchmark completed");
