...
static float input0_storage[361] __attribute__((aligned(64)));
...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 19, 19, 1, 361, 19, 1, 1, input1_storage, input1_storage, 0, 5, 5, 1, 6, 30, 6, 6, 1, input2_storage, input2_storage, 0, 1, 8, 8, 6, 384, 48, 6, 1, output0_storage, output0_storage, 0, 1, 8, 8, 6, 384, 48, 6, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00025_0551817a: benchmark completed");
