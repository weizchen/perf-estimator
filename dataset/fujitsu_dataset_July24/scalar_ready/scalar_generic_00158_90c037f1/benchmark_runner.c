...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 20, 1, input1_storage, input1_storage, 0, 20, 1, output0_storage, output0_storage, 0, 20, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00158_90c037f1: benchmark completed");
