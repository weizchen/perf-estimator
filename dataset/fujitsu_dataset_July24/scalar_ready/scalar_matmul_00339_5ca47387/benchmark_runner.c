...
static float input0_storage[557056] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 557056, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 128, 128, 1, input2_storage, input2_storage, 0, 256, 128, 128, 1, output0_storage, output0_storage, 0, 256, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00339_5ca47387: benchmark completed");
