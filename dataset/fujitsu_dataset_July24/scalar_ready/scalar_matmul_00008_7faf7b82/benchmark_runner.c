...
static int8_t input1_storage[2162688] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 2162688, 2);
  fill_i32(input2_storage, 393216, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 2816, 2816, 1, input1_storage, input1_storage, 0, 2816, 768, 768, 1, input2_storage, input2_storage, 0, 512, 768, 768, 1, output0_storage, output0_storage, 0, 512, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00008_7faf7b82: benchmark completed");
