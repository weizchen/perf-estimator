...
static uint16_t input0_storage[2285568] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 2285568, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1984, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 192, 192, 1, input2_storage, input2_storage, 0, 1984, 192, 192, 1, output0_storage, output0_storage, 0, 1984, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00201_80fbbaa7: benchmark completed");
