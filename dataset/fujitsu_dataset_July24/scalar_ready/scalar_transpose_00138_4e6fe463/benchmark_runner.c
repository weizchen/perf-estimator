...
static float input0_storage[72] __attribute__((aligned(64)));
static float input1_storage[72] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 72, 1);
  fill_f32(input1_storage, 72, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_transpose_00138_4e6fe463: benchmark completed");
