...
static float input1_storage[4704] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 4704, 2);
  fill_f32(input2_storage, 524288, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 3, 518, 518, 804972, 268324, 518, 1, input1_storage, input1_storage, 0, 32, 3, 7, 7, 147, 49, 7, 1, input2_storage, input2_storage, 0, 1, 32, 128, 128, 524288, 16384, 128, 1, output0_storage, output0_storage, 0, 1, 32, 128, 128, 524288, 16384, 128, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start0_end5_0__forward__op1__scalar: benchmark completed");
