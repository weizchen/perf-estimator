...
static float input0_storage[1171456] __attribute__((aligned(64)));
static float input1_storage[319488] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1171456, 1);
  fill_f32(input1_storage, 319488, 2);
  fill_f32(input2_storage, 135168, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 704, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 192, 192, 1, input2_storage, input2_storage, 0, 704, 192, 192, 1, output0_storage, output0_storage, 0, 704, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00342_043ec45c: benchmark completed");
