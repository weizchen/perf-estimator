...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 128, 128, 1, input1_storage, input1_storage, 0, 1, 128, 128, 16384, 128, 1, output0_storage, output0_storage, 0, 1, 128, 128, 16384, 128, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start133_end138_21__forward__op2__scalar: benchmark completed");
