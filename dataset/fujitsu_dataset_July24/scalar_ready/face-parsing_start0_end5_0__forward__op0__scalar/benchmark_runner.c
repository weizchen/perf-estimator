...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 1, input1_storage, input1_storage, 0, 1, 64, 128, 128, 1048576, 16384, 128, 1, output0_storage, output0_storage, 0, 1, 64, 128, 128, 1048576, 16384, 128, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start0_end5_0__forward__op0__scalar: benchmark completed");
