...
static uint16_t input1_storage[368640] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 368640, 2);
  fill_f16(input2_storage, 229376, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1792, 2880, 2880, 1, input1_storage, input1_storage, 0, 2880, 128, 128, 1, input2_storage, input2_storage, 0, 1792, 128, 128, 1, output0_storage, output0_storage, 0, 1792, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00223_c8e5a636: benchmark completed");
