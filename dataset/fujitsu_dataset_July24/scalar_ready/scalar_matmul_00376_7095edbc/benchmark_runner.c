...
static float input1_storage[9338880] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 9338880, 2);
  fill_f32(input2_storage, 983040, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 3648, 3648, 1, input1_storage, input1_storage, 0, 3648, 2560, 2560, 1, input2_storage, input2_storage, 0, 384, 2560, 2560, 1, output0_storage, output0_storage, 0, 384, 2560, 2560, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00376_7095edbc: benchmark completed");
