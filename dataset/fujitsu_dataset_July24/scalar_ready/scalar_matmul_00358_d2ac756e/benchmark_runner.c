...
static float input1_storage[442368] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 442368, 2);
  fill_f32(input2_storage, 663552, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 128, 128, 1, input1_storage, input1_storage, 0, 128, 3456, 3456, 1, input2_storage, input2_storage, 0, 192, 3456, 3456, 1, output0_storage, output0_storage, 0, 192, 3456, 3456, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00358_d2ac756e: benchmark completed");
