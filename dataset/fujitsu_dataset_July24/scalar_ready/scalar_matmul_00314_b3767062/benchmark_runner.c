...
static uint16_t input0_storage[40960] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 40960, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 320, 320, 1, input1_storage, input1_storage, 0, 320, 2048, 2048, 1, input2_storage, input2_storage, 0, 128, 2048, 2048, 1, output0_storage, output0_storage, 0, 128, 2048, 2048, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00314_b3767062: benchmark completed");
