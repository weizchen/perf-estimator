...
static float input0_storage[1720320] __attribute__((aligned(64)));
static float input1_storage[1720320] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1720320, 1);
  fill_f32(input1_storage, 1720320, 2);
  fill_f32(input2_storage, 409600, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 2688, 2688, 1, input1_storage, input1_storage, 0, 2688, 640, 640, 1, input2_storage, input2_storage, 0, 640, 640, 640, 1, output0_storage, output0_storage, 0, 640, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00381_a871dba4: benchmark completed");
