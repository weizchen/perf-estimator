...
static uint16_t input1_storage[324] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 324, 2);
  fill_f32(input2_storage, 64, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 9, 9, 9, 729, 81, 9, 1, input1_storage, input1_storage, 0, 3, 3, 9, 4, 108, 36, 4, 1, input2_storage, input2_storage, 0, 1, 4, 4, 4, 64, 16, 4, 1, output0_storage, output0_storage, 0, 1, 4, 4, 4, 64, 16, 4, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00078_beed19f0: benchmark completed");
