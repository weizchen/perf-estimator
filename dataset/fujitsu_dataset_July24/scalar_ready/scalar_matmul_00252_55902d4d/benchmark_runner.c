...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 1728, 1728, 1, input1_storage, input1_storage, 0, 1728, 128, 128, 1, input2_storage, input2_storage, 0, 384, 128, 128, 1, output0_storage, output0_storage, 0, 384, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00252_55902d4d: benchmark completed");
