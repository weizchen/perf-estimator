...
static int16_t input1_storage[1136] __attribute__((aligned(64)));
static int16_t output0_storage[1136] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i16(input1_storage, 1136, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00556_f708fafd: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 1136));
  return 0;
}
