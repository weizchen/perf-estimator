...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 640, 640, 1, input1_storage, input1_storage, 0, 640, 512, 512, 1, input2_storage, input2_storage, 0, 768, 512, 512, 1, output0_storage, output0_storage, 0, 768, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00097_01aed4af: benchmark completed");
