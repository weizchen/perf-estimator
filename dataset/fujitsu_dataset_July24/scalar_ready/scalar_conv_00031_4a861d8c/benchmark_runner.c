...
static int8_t input1_storage[147] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 147, 2);
  fill_i32(input2_storage, 300, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 16, 16, 1, 256, 16, 1, 1, input1_storage, input1_storage, 0, 7, 7, 1, 3, 21, 3, 3, 1, input2_storage, input2_storage, 0, 1, 10, 10, 3, 300, 30, 3, 1, output0_storage, output0_storage, 0, 1, 10, 10, 3, 300, 30, 3, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00031_4a861d8c: benchmark completed");
