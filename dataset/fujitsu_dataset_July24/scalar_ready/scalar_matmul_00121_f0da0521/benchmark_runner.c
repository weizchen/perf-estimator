...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 64, 64, 1, input1_storage, input1_storage, 0, 64, 640, 640, 1, input2_storage, input2_storage, 0, 192, 640, 640, 1, output0_storage, output0_storage, 0, 192, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00121_f0da0521: benchmark completed");
