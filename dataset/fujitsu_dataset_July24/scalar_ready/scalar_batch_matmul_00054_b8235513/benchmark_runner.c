...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2, 128, 704, 90112, 704, 1, input1_storage, input1_storage, 0, 2, 704, 576, 405504, 576, 1, input2_storage, input2_storage, 0, 2, 128, 576, 73728, 576, 1, output0_storage, output0_storage, 0, 2, 128, 576, 73728, 576, 1);
  ofa_dma_memory_fence();
  puts("scalar_batch_matmul_00054_b8235513: benchmark completed");
