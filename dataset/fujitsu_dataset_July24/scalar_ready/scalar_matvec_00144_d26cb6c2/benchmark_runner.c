...
static uint16_t input0_storage[409600] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 409600, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1600, 256, 256, 1, input1_storage, input1_storage, 0, 256, 1, input2_storage, input2_storage, 0, 1600, 1, output0_storage, output0_storage, 0, 1600, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00144_d26cb6c2: benchmark completed");
