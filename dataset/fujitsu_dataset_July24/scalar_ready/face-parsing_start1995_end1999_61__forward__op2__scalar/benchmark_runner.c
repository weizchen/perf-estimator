...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 512, 512, 1, input1_storage, input1_storage, 0, 1, 512, 512, 262144, 512, 1, output0_storage, output0_storage, 0, 1, 512, 512, 262144, 512, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start1995_end1999_61__forward__op2__scalar: benchmark completed");
