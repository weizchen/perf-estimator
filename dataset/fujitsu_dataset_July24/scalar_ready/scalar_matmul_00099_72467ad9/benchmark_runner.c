...
static int8_t input0_storage[2293760] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 2293760, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 384, 384, 1, input2_storage, input2_storage, 0, 640, 384, 384, 1, output0_storage, output0_storage, 0, 640, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00099_72467ad9: benchmark completed");
