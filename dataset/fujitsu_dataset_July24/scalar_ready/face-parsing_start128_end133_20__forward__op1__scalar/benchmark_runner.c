...
static float input0_storage[1081600] __attribute__((aligned(64)));
static float input1_storage[73728] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 1081600, 1);
  fill_f32(input1_storage, 73728, 2);
  fill_f32(input2_storage, 524288, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 64, 130, 130, 1081600, 16900, 130, 1, input1_storage, input1_storage, 0, 128, 64, 3, 3, 576, 9, 3, 1, input2_storage, input2_storage, 0, 1, 128, 64, 64, 524288, 4096, 64, 1, output0_storage, output0_storage, 0, 1, 128, 64, 64, 524288, 4096, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start128_end133_20__forward__op1__scalar: benchmark completed");
