...
static float input0_storage[319488] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 319488, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1664, 192, 192, 1, input1_storage, input1_storage, 0, 192, 128, 128, 1, input2_storage, input2_storage, 0, 1664, 128, 128, 1, output0_storage, output0_storage, 0, 1664, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00414_54bc3c69: benchmark completed");
