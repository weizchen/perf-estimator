...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 16, 512, 64, 524288, 32768, 64, 1, input1_storage, input1_storage, 0, 1, 16, 64, 512, 524288, 32768, 512, 1, output0_storage, output0_storage, 0, 1, 16, 64, 512, 524288, 32768, 512, 1);
  ofa_dma_memory_fence();
  puts("AI-Nordics_bert-large-swedish-cased_start18_end22_4__forward__op7__scalar: benchmark completed");
