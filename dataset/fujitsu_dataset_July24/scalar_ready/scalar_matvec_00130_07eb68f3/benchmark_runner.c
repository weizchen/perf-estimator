...
static uint16_t input0_storage[196608] __attribute__((aligned(64)));
static uint16_t input1_storage[512] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 196608, 1);
  fill_f16(input1_storage, 512, 2);
  fill_f32(input2_storage, 384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1, input2_storage, input2_storage, 0, 384, 1, output0_storage, output0_storage, 0, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00130_07eb68f3: benchmark completed");
