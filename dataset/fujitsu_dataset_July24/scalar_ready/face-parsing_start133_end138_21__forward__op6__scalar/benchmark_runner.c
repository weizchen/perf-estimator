...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 4096, 2, 64, 524288, 128, 64, 1, input1_storage, input1_storage, 0, 1, 2, 4096, 64, 524288, 262144, 64, 1, output0_storage, output0_storage, 0, 1, 2, 4096, 64, 524288, 262144, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start133_end138_21__forward__op6__scalar: benchmark completed");
