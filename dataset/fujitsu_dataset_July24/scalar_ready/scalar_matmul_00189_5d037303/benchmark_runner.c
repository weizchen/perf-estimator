...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 448, 448, 1, input1_storage, input1_storage, 0, 448, 192, 192, 1, input2_storage, input2_storage, 0, 640, 192, 192, 1, output0_storage, output0_storage, 0, 640, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00189_5d037303: benchmark completed");
