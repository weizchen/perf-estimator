...
static float input0_storage[945] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 945, 1);
  fill_f32(input1_storage, 21, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 21, 45, 45, 1, input1_storage, input1_storage, 0, 21, 1, output0_storage, output0_storage, 0, 21, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00255_0af9082d: benchmark completed");
