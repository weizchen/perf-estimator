...
static float input0_storage[2088960] __attribute__((aligned(64)));
static float input1_storage[278528] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2088960, 1);
  fill_f32(input1_storage, 278528, 2);
  fill_f32(input2_storage, 122880, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 960, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 128, 128, 1, input2_storage, input2_storage, 0, 960, 128, 128, 1, output0_storage, output0_storage, 0, 960, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00327_18e0d5e0: benchmark completed");
