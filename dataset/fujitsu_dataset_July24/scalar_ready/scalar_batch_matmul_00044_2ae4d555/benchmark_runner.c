...
static uint16_t input0_storage[147456] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 147456, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 4, 192, 192, 36864, 192, 1, input1_storage, input1_storage, 0, 4, 192, 192, 36864, 192, 1, input2_storage, input2_storage, 0, 4, 192, 192, 36864, 192, 1, output0_storage, output0_storage, 0, 4, 192, 192, 36864, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_batch_matmul_00044_2ae4d555: benchmark completed");
