...
static uint16_t input1_storage[12288] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 12288, 2);
  fill_f32(input2_storage, 192, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 1, input1_storage, input1_storage, 0, 64, 192, 192, 1, input2_storage, input2_storage, 0, 192, 1, output0_storage, output0_storage, 0, 192, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00237_e941aa71: benchmark completed");
