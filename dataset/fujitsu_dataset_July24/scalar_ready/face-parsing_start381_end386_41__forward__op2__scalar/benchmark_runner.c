...
static float input0_storage[102400] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 102400, 1);
  fill_f32(input1_storage, 102400, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 320, 320, 1, input1_storage, input1_storage, 0, 1, 320, 320, 102400, 320, 1, output0_storage, output0_storage, 0, 1, 320, 320, 102400, 320, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start381_end386_41__forward__op2__scalar: benchmark completed");
