...
static int8_t input1_storage[13762560] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 13762560, 2);
  fill_i32(input2_storage, 1376256, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 3584, 3584, 1, input2_storage, input2_storage, 0, 384, 3584, 3584, 1, output0_storage, output0_storage, 0, 384, 3584, 3584, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00014_1cb77594: benchmark completed");
