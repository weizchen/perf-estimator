...
static float input1_storage[266240] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 266240, 2);
  fill_f32(input2_storage, 20480, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 832, 832, 1, input1_storage, input1_storage, 0, 832, 320, 320, 1, input2_storage, input2_storage, 0, 64, 320, 320, 1, output0_storage, output0_storage, 0, 64, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00385_b8c23b6a: benchmark completed");
