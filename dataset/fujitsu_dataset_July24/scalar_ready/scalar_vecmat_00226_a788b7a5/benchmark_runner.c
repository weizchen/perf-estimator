...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 1, input1_storage, input1_storage, 0, 128, 1152, 1152, 1, input2_storage, input2_storage, 0, 1152, 1, output0_storage, output0_storage, 0, 1152, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00226_a788b7a5: benchmark completed");
