...
static float input0_storage[245760] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 245760, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 2688, 2688, 1, input2_storage, input2_storage, 0, 128, 2688, 2688, 1, output0_storage, output0_storage, 0, 128, 2688, 2688, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00338_4b3a982b: benchmark completed");
