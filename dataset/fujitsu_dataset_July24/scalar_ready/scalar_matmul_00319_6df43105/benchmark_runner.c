...
static float input1_storage[57344] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 57344, 2);
  fill_f32(input2_storage, 28672, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 128, 128, 1, input1_storage, input1_storage, 0, 128, 448, 448, 1, input2_storage, input2_storage, 0, 64, 448, 448, 1, output0_storage, output0_storage, 0, 64, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00319_6df43105: benchmark completed");
