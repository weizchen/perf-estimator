...
static int8_t input0_storage[161616] __attribute__((aligned(64)));
static int8_t input1_storage[161616] __attribute__((aligned(64)));
static int8_t output0_storage[161616] __attribute__((aligned(64)));

extern void kernel(int8_t *arg0_allocated, int8_t *arg0_aligned, int64_t arg0_offset, int64_t arg0_size0, int64_t arg0_size1, int64_t arg0_size2, int64_t arg0_size3, int64_t arg0_stride0, int64_t arg0_stride1, int64_t arg0_stride2, int64_t arg0_stride3, int8_t *arg1_allocated, int8_t *arg1_aligned, int64_t arg1_offset, int64_t arg1_size0, int64_t arg1_size1, int64_t arg1_size2, int64_t arg1_size3, int64_t arg1_stride0, int64_t arg1_stride1, int64_t arg1_stride2, int64_t arg1_stride3, int8_t *result0_allocated, int8_t *result0_aligned, int64_t result0_offset, int64_t result0_size0, int64_t result0_size1, int64_t result0_size2, int64_t result0_size3, int64_t result0_stride0, int64_t result0_stride1, int64_t result0_stride2, int64_t result0_stride3);

int main(void) {
  fill_i8(input0_storage, 161616, 1);
  fill_i8(input1_storage, 161616, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 37, 13, 16, 21, 4368, 336, 21, 1, input1_storage, input1_storage, 0, 37, 21, 16, 13, 4368, 208, 13, 1, output0_storage, output0_storage, 0, 37, 21, 16, 13, 4368, 208, 13, 1);
  ofa_dma_memory_fence();
  puts("scalar_transpose_00068_0aacc40a: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 161616));
  return 0;
}
