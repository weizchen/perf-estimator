...
static int8_t input0_storage[1920] __attribute__((aligned(64)));
static int8_t input1_storage[1228800] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1920, 1);
  fill_i8(input1_storage, 1228800, 2);
  fill_i32(input2_storage, 640, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1920, 1, input1_storage, input1_storage, 0, 1920, 640, 640, 1, input2_storage, input2_storage, 0, 640, 1, output0_storage, output0_storage, 0, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00215_704ceee6: benchmark completed");
