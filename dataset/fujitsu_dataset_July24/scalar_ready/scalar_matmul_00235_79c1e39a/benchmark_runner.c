...
static uint16_t input0_storage[294912] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 294912, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 512, 576, 576, 1, input1_storage, input1_storage, 0, 576, 1664, 1664, 1, input2_storage, input2_storage, 0, 512, 1664, 1664, 1, output0_storage, output0_storage, 0, 512, 1664, 1664, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00235_79c1e39a: benchmark completed");
