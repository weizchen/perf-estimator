...
static int8_t input0_storage[5488] __attribute__((aligned(64)));
static int8_t input1_storage[91] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 5488, 1);
  fill_i8(input1_storage, 91, 2);
  fill_i32(input2_storage, 2548, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 28, 28, 7, 5488, 196, 7, 1, input1_storage, input1_storage, 0, 1, 1, 7, 13, 91, 91, 13, 1, input2_storage, input2_storage, 0, 1, 14, 14, 13, 2548, 182, 13, 1, output0_storage, output0_storage, 0, 1, 14, 14, 13, 2548, 182, 13, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00017_8cd344af: benchmark completed");
