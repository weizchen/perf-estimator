...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 9, 10, 10, 1, input1_storage, input1_storage, 0, 10, 1, output0_storage, output0_storage, 0, 10, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00253_66ae82f9: benchmark completed");
