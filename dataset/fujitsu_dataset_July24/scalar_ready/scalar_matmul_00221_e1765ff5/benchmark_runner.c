...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 320, 64, 64, 1, input1_storage, input1_storage, 0, 64, 768, 768, 1, input2_storage, input2_storage, 0, 320, 768, 768, 1, output0_storage, output0_storage, 0, 320, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00221_e1765ff5: benchmark completed");
