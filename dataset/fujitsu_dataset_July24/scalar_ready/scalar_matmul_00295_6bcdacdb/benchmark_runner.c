...
int main(void) {
  fill_f16(input0_storage, 1130496, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2944, 384, 384, 1, input1_storage, input1_storage, 0, 384, 64, 64, 1, input2_storage, input2_storage, 0, 2944, 64, 64, 1, output0_storage, output0_storage, 0, 2944, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00295_6bcdacdb: benchmark completed");
