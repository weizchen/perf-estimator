...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 256, 256, 1, input1_storage, input1_storage, 0, 1, 256, 256, 65536, 256, 1, output0_storage, output0_storage, 0, 1, 256, 256, 65536, 256, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start275_end279_53__forward__op2__scalar: benchmark completed");
