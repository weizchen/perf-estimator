...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 16384, 1, 64, 1048576, 64, 64, 1, input1_storage, input1_storage, 0, 1, 1, 16384, 64, 1048576, 1048576, 64, 1, output0_storage, output0_storage, 0, 1, 1, 16384, 64, 1048576, 1048576, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start46_end50_12__forward__op0__scalar: benchmark completed");
