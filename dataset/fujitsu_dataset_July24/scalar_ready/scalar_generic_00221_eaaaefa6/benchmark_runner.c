...
static int16_t input0_storage[109] __attribute__((aligned(64)));
static int16_t input1_storage[109] __attribute__((aligned(64)));
static int16_t output0_storage[109] __attribute__((aligned(64)));
...
int main(void) {
  fill_i16(input0_storage, 109, 1);
  fill_i16(input1_storage, 109, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00221_eaaaefa6: benchmark completed");
  printf("output0_i16_checksum=%lld\n", checksum_i16(output0_storage, 109));
  return 0;
}
