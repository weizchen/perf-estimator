...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 8, 256, 64, 131072, 16384, 64, 1, input1_storage, input1_storage, 0, 1, 8, 64, 256, 131072, 16384, 256, 1, output0_storage, output0_storage, 0, 1, 8, 64, 256, 131072, 16384, 256, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start1995_end1999_61__forward__op7__scalar: benchmark completed");
