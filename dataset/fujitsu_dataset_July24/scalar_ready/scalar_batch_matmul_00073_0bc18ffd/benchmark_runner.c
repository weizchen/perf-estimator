...
static uint16_t input1_storage[163840] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 163840, 2);
  fill_f16(input2_storage, 327680, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 4, 128, 64, 8192, 64, 1, input1_storage, input1_storage, 0, 4, 64, 640, 40960, 640, 1, input2_storage, input2_storage, 0, 4, 128, 640, 81920, 640, 1, output0_storage, output0_storage, 0, 4, 128, 640, 81920, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_batch_matmul_00073_0bc18ffd: benchmark completed");
