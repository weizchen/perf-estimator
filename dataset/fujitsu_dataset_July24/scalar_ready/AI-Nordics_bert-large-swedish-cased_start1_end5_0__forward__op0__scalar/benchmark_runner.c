...
static int64_t input0_storage[512] __attribute__((aligned(64)));
...
int main(void) {
  fill_i64(input0_storage, 512, 1);
  fill_f32(input1_storage, 512, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 1, 1, 512, 512, 512, 512, 1, input1_storage, input1_storage, 0, 1, 1, 1, 512, 512, 512, 512, 1, output0_storage, output0_storage, 0, 1, 1, 1, 512, 512, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("AI-Nordics_bert-large-swedish-cased_start1_end5_0__forward__op0__scalar: benchmark completed");
