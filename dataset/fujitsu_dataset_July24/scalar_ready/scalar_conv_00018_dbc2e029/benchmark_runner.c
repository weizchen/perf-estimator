...
static int8_t input0_storage[1296] __attribute__((aligned(64)));
static int8_t input1_storage[18] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1296, 1);
  fill_i8(input1_storage, 18, 2);
  fill_i32(input2_storage, 2312, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 36, 36, 1, 1296, 36, 1, 1, input1_storage, input1_storage, 0, 3, 3, 1, 2, 6, 2, 2, 1, input2_storage, input2_storage, 0, 1, 34, 34, 2, 2312, 68, 2, 1, output0_storage, output0_storage, 0, 1, 34, 34, 2, 2312, 68, 2, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00018_dbc2e029: benchmark completed");
