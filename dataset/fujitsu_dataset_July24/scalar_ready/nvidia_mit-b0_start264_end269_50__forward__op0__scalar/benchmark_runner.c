...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1, input1_storage, input1_storage, 0, 1, 256, 16, 16, 65536, 256, 16, 1, output0_storage, output0_storage, 0, 1, 256, 16, 16, 65536, 256, 16, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start264_end269_50__forward__op0__scalar: benchmark completed");
