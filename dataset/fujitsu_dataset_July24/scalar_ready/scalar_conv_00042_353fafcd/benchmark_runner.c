...
static int8_t input0_storage[841] __attribute__((aligned(64)));
static int8_t input1_storage[2156] __attribute__((aligned(64)));
static int32_t input2_storage[6336] __attribute__((aligned(64)));
static int32_t output0_storage[6336] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 841, 1);
  fill_i8(input1_storage, 2156, 2);
  fill_i32(input2_storage, 6336, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 29, 29, 1, 841, 29, 1, 1, input1_storage, input1_storage, 0, 7, 7, 1, 44, 308, 44, 44, 1, input2_storage, input2_storage, 0, 1, 12, 12, 44, 6336, 528, 44, 1, output0_storage, output0_storage, 0, 1, 12, 12, 44, 6336, 528, 44, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00042_353fafcd: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 6336));
  return 0;
}
