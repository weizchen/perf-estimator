...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2048, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 256, 256, 1, input2_storage, input2_storage, 0, 2048, 256, 256, 1, output0_storage, output0_storage, 0, 2048, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00054_6a5e32a8: benchmark completed");
