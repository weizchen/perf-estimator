...
static float input1_storage[800] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 800, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 800, 1, input1_storage, input1_storage, 0, 800, 1, output0_storage, output0_storage, 0, 800, 1);
  ofa_dma_memory_fence();
  puts("scalar_generic_00164_ab21a103: benchmark completed");
