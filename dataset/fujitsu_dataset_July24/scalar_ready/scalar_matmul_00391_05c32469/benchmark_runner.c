...
static float input0_storage[159744] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 159744, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2496, 64, 64, 1, input1_storage, input1_storage, 0, 64, 256, 256, 1, input2_storage, input2_storage, 0, 2496, 256, 256, 1, output0_storage, output0_storage, 0, 2496, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00391_05c32469: benchmark completed");
