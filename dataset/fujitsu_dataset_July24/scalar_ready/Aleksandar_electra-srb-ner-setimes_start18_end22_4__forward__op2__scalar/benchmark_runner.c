...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 768, 768, 1, input1_storage, input1_storage, 0, 1, 768, 768, 589824, 768, 1, output0_storage, output0_storage, 0, 1, 768, 768, 589824, 768, 1);
  ofa_dma_memory_fence();
  puts("Aleksandar_electra-srb-ner-setimes_start18_end22_4__forward__op2__scalar: benchmark completed");
