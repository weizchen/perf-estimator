...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 3328, 3328, 1, input2_storage, input2_storage, 0, 512, 3328, 3328, 1, output0_storage, output0_storage, 0, 512, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00143_6089b0f0: benchmark completed");
