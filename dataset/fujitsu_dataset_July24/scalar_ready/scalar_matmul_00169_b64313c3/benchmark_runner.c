...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 128, 128, 1, input1_storage, input1_storage, 0, 128, 4032, 4032, 1, input2_storage, input2_storage, 0, 64, 4032, 4032, 1, output0_storage, output0_storage, 0, 64, 4032, 4032, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00169_b64313c3: benchmark completed");
