...
static float input0_storage[5898240] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 5898240, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1536, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 128, 128, 1, input2_storage, input2_storage, 0, 1536, 128, 128, 1, output0_storage, output0_storage, 0, 1536, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00368_db3517e5: benchmark completed");
