...
static float input1_storage[21] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 21, 2);
  fill_f32(input2_storage, 768, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 16, 16, 7, 1792, 112, 7, 1, input1_storage, input1_storage, 0, 1, 1, 7, 3, 21, 21, 3, 1, input2_storage, input2_storage, 0, 1, 16, 16, 3, 768, 48, 3, 1, output0_storage, output0_storage, 0, 1, 16, 16, 3, 768, 48, 3, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00093_f4fb5d63: benchmark completed");
