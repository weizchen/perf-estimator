...
static int8_t input1_storage[688128] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 688128, 2);
  fill_i32(input2_storage, 262144, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1024, 2688, 2688, 1, input1_storage, input1_storage, 0, 2688, 256, 256, 1, input2_storage, input2_storage, 0, 1024, 256, 256, 1, output0_storage, output0_storage, 0, 1024, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00096_10a36e91: benchmark completed");
