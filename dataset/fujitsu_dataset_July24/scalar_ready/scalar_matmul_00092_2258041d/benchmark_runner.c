...
static int8_t input1_storage[720896] __attribute__((aligned(64)));
static int32_t input2_storage[4325376] __attribute__((aligned(64)));
static int32_t output0_storage[4325376] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 720896, 2);
  fill_i32(input2_storage, 4325376, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1536, 256, 256, 1, input1_storage, input1_storage, 0, 256, 2816, 2816, 1, input2_storage, input2_storage, 0, 1536, 2816, 2816, 1, output0_storage, output0_storage, 0, 1536, 2816, 2816, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00092_2258041d: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 4325376));
  return 0;
}
