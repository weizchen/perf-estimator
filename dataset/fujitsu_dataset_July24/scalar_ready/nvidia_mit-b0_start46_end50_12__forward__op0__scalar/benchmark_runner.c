...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1, 16384, 1, 32, 524288, 32, 32, 1, input1_storage, input1_storage, 0, 1, 1, 16384, 32, 524288, 524288, 32, 1, output0_storage, output0_storage, 0, 1, 1, 16384, 32, 524288, 524288, 32, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start46_end50_12__forward__op0__scalar: benchmark completed");
