...
static int8_t input0_storage[5184] __attribute__((aligned(64)));
static int8_t input1_storage[432] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 5184, 1);
  fill_i8(input1_storage, 432, 2);
  fill_i32(input2_storage, 768, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 18, 18, 16, 5184, 288, 16, 1, input1_storage, input1_storage, 0, 3, 3, 16, 3, 144, 48, 3, 1, input2_storage, input2_storage, 0, 1, 16, 16, 3, 768, 48, 3, 1, output0_storage, output0_storage, 0, 1, 16, 16, 3, 768, 48, 3, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00039_389c852b: benchmark completed");
