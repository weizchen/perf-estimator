...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 576, 576, 1, input1_storage, input1_storage, 0, 576, 384, 384, 1, input2_storage, input2_storage, 0, 704, 384, 384, 1, output0_storage, output0_storage, 0, 704, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00264_843716dc: benchmark completed");
