...
static int8_t input0_storage[3481] __attribute__((aligned(64)));
static int8_t input1_storage[144] __attribute__((aligned(64)));
static int32_t input2_storage[51984] __attribute__((aligned(64)));
static int32_t output0_storage[51984] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 3481, 1);
  fill_i8(input1_storage, 144, 2);
  fill_i32(input2_storage, 51984, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 59, 59, 1, 3481, 59, 1, 1, input1_storage, input1_storage, 0, 3, 3, 1, 16, 48, 16, 16, 1, input2_storage, input2_storage, 0, 1, 57, 57, 16, 51984, 912, 16, 1, output0_storage, output0_storage, 0, 1, 57, 57, 16, 51984, 912, 16, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00027_d0df5ca4: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 51984));
  return 0;
}
