...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 832, 832, 1, input1_storage, input1_storage, 0, 832, 1, input2_storage, input2_storage, 0, 640, 1, output0_storage, output0_storage, 0, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00149_d8990046: benchmark completed");
