...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 448, 448, 1, input1_storage, input1_storage, 0, 448, 640, 640, 1, input2_storage, input2_storage, 0, 192, 640, 640, 1, output0_storage, output0_storage, 0, 192, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00176_2fbf4bc6: benchmark completed");
