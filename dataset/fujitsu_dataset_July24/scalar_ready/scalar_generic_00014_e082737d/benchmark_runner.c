...
static int8_t input0_storage[98] __attribute__((aligned(64)));
static int8_t input1_storage[98] __attribute__((aligned(64)));
static int8_t output0_storage[98] __attribute__((aligned(64)));
...
int main(void) {
  ...
  ofa_dma_memory_fence();
  puts("scalar_generic_00014_e082737d: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 98));
  return 0;
}
