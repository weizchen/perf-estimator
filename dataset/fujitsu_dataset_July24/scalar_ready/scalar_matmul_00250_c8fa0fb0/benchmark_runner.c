...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 64, 64, 1, input2_storage, input2_storage, 0, 1280, 64, 64, 1, output0_storage, output0_storage, 0, 1280, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00250_c8fa0fb0: benchmark completed");
