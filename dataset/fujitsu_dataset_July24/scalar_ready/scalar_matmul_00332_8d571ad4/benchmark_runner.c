...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1344, 128, 128, 1, input1_storage, input1_storage, 0, 128, 640, 640, 1, input2_storage, input2_storage, 0, 1344, 640, 640, 1, output0_storage, output0_storage, 0, 1344, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00332_8d571ad4: benchmark completed");
