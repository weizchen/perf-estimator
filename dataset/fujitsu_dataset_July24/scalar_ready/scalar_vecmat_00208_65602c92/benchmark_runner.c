...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1, input1_storage, input1_storage, 0, 256, 896, 896, 1, input2_storage, input2_storage, 0, 896, 1, output0_storage, output0_storage, 0, 896, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00208_65602c92: benchmark completed");
