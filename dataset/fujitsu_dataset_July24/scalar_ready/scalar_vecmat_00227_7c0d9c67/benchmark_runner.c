...
static uint16_t input0_storage[320] __attribute__((aligned(64)));
static uint16_t input1_storage[20480] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 320, 1);
  fill_f16(input1_storage, 20480, 2);
  ...
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00227_7c0d9c67: benchmark completed");
