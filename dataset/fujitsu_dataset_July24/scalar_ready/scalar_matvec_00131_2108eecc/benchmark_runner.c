...
static uint16_t input0_storage[372736] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 372736, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 832, 832, 1, input1_storage, input1_storage, 0, 832, 1, input2_storage, input2_storage, 0, 448, 1, output0_storage, output0_storage, 0, 448, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00131_2108eecc: benchmark completed");
