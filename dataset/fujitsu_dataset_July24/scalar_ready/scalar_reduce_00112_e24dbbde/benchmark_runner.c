...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 4, 27, 27, 1, input1_storage, input1_storage, 0, 4, 1, output0_storage, output0_storage, 0, 4, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00112_e24dbbde: benchmark completed");
