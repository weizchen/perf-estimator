...
static int8_t input0_storage[278528] __attribute__((aligned(64)));
static int8_t input1_storage[425984] __attribute__((aligned(64)));
static int32_t input2_storage[7241728] __attribute__((aligned(64)));
static int32_t output0_storage[7241728] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 278528, 1);
  fill_i8(input1_storage, 425984, 2);
  fill_i32(input2_storage, 7241728, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2176, 128, 128, 1, input1_storage, input1_storage, 0, 128, 3328, 3328, 1, input2_storage, input2_storage, 0, 2176, 3328, 3328, 1, output0_storage, output0_storage, 0, 2176, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00105_533f7161: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 7241728));
  return 0;
}
