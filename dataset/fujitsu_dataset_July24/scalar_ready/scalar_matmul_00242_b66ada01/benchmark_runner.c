...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 256, 256, 1, input1_storage, input1_storage, 0, 256, 1024, 1024, 1, input2_storage, input2_storage, 0, 128, 1024, 1024, 1, output0_storage, output0_storage, 0, 128, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00242_b66ada01: benchmark completed");
