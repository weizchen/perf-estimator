...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1792, 64, 64, 1, input1_storage, input1_storage, 0, 64, 128, 128, 1, input2_storage, input2_storage, 0, 1792, 128, 128, 1, output0_storage, output0_storage, 0, 1792, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00172_9b927f2d: benchmark completed");
