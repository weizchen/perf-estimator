...
static int8_t input0_storage[16384] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 16384, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 128, 128, 1, input1_storage, input1_storage, 0, 128, 2816, 2816, 1, input2_storage, input2_storage, 0, 128, 2816, 2816, 1, output0_storage, output0_storage, 0, 128, 2816, 2816, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00086_0b6dc744: benchmark completed");
