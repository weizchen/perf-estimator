...
static float input1_storage[450] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 450, 2);
  fill_f32(input2_storage, 882, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 18, 18, 1, 324, 18, 1, 1, input1_storage, input1_storage, 0, 5, 5, 1, 18, 90, 18, 18, 1, input2_storage, input2_storage, 0, 1, 7, 7, 18, 882, 126, 18, 1, output0_storage, output0_storage, 0, 1, 7, 7, 18, 882, 126, 18, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00127_524da15a: benchmark completed");
