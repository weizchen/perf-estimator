...
static float input0_storage[557568] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 557568, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1, 128, 66, 66, 557568, 4356, 66, 1, input1_storage, input1_storage, 0, 320, 128, 3, 3, 1152, 9, 3, 1, input2_storage, input2_storage, 0, 1, 320, 32, 32, 327680, 1024, 32, 1, output0_storage, output0_storage, 0, 1, 320, 32, 32, 327680, 1024, 32, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start376_end381_40__forward__op1__scalar: benchmark completed");
