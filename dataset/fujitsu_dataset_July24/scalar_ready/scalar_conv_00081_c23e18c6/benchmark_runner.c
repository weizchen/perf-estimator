...
static int8_t input0_storage[103933] __attribute__((aligned(64)));
static int8_t input1_storage[29008] __attribute__((aligned(64)));
static int32_t input2_storage[9216] __attribute__((aligned(64)));
static int32_t output0_storage[9216] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 103933, 1);
  fill_i8(input1_storage, 29008, 2);
  fill_i32(input2_storage, 9216, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 53, 53, 37, 103933, 1961, 37, 1, input1_storage, input1_storage, 0, 7, 7, 37, 16, 4144, 592, 16, 1, input2_storage, input2_storage, 0, 1, 24, 24, 16, 9216, 384, 16, 1, output0_storage, output0_storage, 0, 1, 24, 24, 16, 9216, 384, 16, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00081_c23e18c6: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 9216));
  return 0;
}
