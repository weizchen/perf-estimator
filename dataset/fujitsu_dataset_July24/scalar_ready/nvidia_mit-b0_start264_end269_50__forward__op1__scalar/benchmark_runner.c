...
static float input0_storage[184960] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 184960, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1, 160, 34, 34, 184960, 1156, 34, 1, input1_storage, input1_storage, 0, 256, 160, 3, 3, 1440, 9, 3, 1, input2_storage, input2_storage, 0, 1, 256, 16, 16, 65536, 256, 16, 1, output0_storage, output0_storage, 0, 1, 256, 16, 16, 65536, 256, 16, 1);
  ofa_dma_memory_fence();
  puts("nvidia_mit-b0_start264_end269_50__forward__op1__scalar: benchmark completed");
