...
static uint16_t input1_storage[196] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 196, 2);
  fill_f32(input2_storage, 4, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 8, 8, 1, 64, 8, 1, 1, input1_storage, input1_storage, 0, 7, 7, 1, 4, 28, 4, 4, 1, input2_storage, input2_storage, 0, 1, 1, 1, 4, 4, 4, 4, 1, output0_storage, output0_storage, 0, 1, 1, 1, 4, 4, 4, 4, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00047_5fd9775a: benchmark completed");
