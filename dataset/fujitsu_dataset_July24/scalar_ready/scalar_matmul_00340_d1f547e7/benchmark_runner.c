...
static float input1_storage[1757184] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input1_storage, 1757184, 2);
  fill_f32(input2_storage, 479232, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 704, 704, 1, input1_storage, input1_storage, 0, 704, 2496, 2496, 1, input2_storage, input2_storage, 0, 192, 2496, 2496, 1, output0_storage, output0_storage, 0, 192, 2496, 2496, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00340_d1f547e7: benchmark completed");
