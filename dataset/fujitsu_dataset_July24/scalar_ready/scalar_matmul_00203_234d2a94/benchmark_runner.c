...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 448, 448, 1, input2_storage, input2_storage, 0, 384, 448, 448, 1, output0_storage, output0_storage, 0, 384, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00203_234d2a94: benchmark completed");
