...
static uint16_t input0_storage[212992] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 212992, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1664, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1, input2_storage, input2_storage, 0, 1664, 1, output0_storage, output0_storage, 0, 1664, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00147_30373184: benchmark completed");
