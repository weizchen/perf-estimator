...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 1, input1_storage, input1_storage, 0, 1, 128, 64, 64, 524288, 4096, 64, 1, output0_storage, output0_storage, 0, 1, 128, 64, 64, 524288, 4096, 64, 1);
  ofa_dma_memory_fence();
  puts("face-parsing_start128_end133_20__forward__op0__scalar: benchmark completed");
