...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 576, 576, 1, input1_storage, input1_storage, 0, 576, 320, 320, 1, input2_storage, input2_storage, 0, 256, 320, 320, 1, output0_storage, output0_storage, 0, 256, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00206_b058af49: benchmark completed");
