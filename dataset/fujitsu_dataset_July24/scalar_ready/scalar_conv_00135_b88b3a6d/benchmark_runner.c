...
static float input0_storage[4864] __attribute__((aligned(64)));
static float input1_storage[475] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 4864, 1);
  fill_f32(input1_storage, 475, 2);
  fill_f32(input2_storage, 36, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1, 16, 16, 19, 4864, 304, 19, 1, input1_storage, input1_storage, 0, 5, 5, 19, 1, 95, 19, 1, 1, input2_storage, input2_storage, 0, 1, 6, 6, 1, 36, 6, 1, 1, output0_storage, output0_storage, 0, 1, 6, 6, 1, 36, 6, 1, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00135_b88b3a6d: benchmark completed");
