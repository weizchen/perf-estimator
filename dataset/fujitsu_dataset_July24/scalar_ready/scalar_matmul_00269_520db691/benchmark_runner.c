...
static uint16_t input0_storage[135168] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 135168, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 704, 192, 192, 1, input1_storage, input1_storage, 0, 192, 384, 384, 1, input2_storage, input2_storage, 0, 704, 384, 384, 1, output0_storage, output0_storage, 0, 704, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00269_520db691: benchmark completed");
