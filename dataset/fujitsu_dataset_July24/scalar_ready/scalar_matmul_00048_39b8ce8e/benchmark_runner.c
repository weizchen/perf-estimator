...
static int8_t input1_storage[114688] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 114688, 2);
  fill_i32(input2_storage, 458752, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 128, 128, 1, input1_storage, input1_storage, 0, 128, 896, 896, 1, input2_storage, input2_storage, 0, 512, 896, 896, 1, output0_storage, output0_storage, 0, 512, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("scalar_matmul_00048_39b8ce8e: benchmark completed");
