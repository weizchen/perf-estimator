...
static float input0_storage[2601] __attribute__((aligned(64)));
...
int main(void) {
  fill_f32(input0_storage, 2601, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1, 17, 17, 9, 2601, 153, 9, 1, input1_storage, input1_storage, 0, 3, 3, 9, 1, 27, 9, 1, 1, input2_storage, input2_storage, 0, 1, 8, 8, 1, 64, 8, 1, 1, output0_storage, output0_storage, 0, 1, 8, 8, 1, 64, 8, 1, 1);
  ofa_dma_memory_fence();
  puts("scalar_conv_00061_96f3d582: benchmark completed");
