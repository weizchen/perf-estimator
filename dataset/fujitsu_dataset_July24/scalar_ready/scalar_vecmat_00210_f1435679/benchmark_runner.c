...
static int8_t input0_storage[1152] __attribute__((aligned(64)));
static int8_t input1_storage[147456] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1152, 1);
  fill_i8(input1_storage, 147456, 2);
  fill_i32(input2_storage, 128, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1152, 1, input1_storage, input1_storage, 0, 1152, 128, 128, 1, input2_storage, input2_storage, 0, 128, 1, output0_storage, output0_storage, 0, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_vecmat_00210_f1435679: benchmark completed");
