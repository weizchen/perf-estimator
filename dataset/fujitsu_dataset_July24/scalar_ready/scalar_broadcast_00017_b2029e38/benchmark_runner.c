...
static int8_t input0_storage[1316] __attribute__((aligned(64)));
static int8_t input1_storage[14476] __attribute__((aligned(64)));
static int8_t output0_storage[14476] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1316, 1);
  fill_i8(input1_storage, 14476, 2);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 7, 188, 188, 1, input1_storage, input1_storage, 0, 7, 11, 188, 2068, 188, 1, output0_storage, output0_storage, 0, 7, 11, 188, 2068, 188, 1);
  ofa_dma_memory_fence();
  puts("scalar_broadcast_00017_b2029e38: benchmark completed");
  printf("output0_i8_checksum=%lld\n", checksum_i8(output0_storage, 14476));
  return 0;
}
