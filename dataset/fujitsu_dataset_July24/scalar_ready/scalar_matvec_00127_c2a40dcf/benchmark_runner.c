...
static uint16_t input1_storage[1152] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1152, 2);
  fill_f32(input2_storage, 128, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 1, input2_storage, input2_storage, 0, 128, 1, output0_storage, output0_storage, 0, 128, 1);
  ofa_dma_memory_fence();
  puts("scalar_matvec_00127_c2a40dcf: benchmark completed");
