...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 6, 36, 36, 1, input1_storage, input1_storage, 0, 6, 1, output0_storage, output0_storage, 0, 6, 1);
  ofa_dma_memory_fence();
  puts("scalar_reduce_00059_8196eb85: benchmark completed");
