...
static uint16_t input0_storage[2494464] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 2494464, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1856, 1344, 1344, 1, input1_storage, input1_storage, 0, 1344, 64, 64, 1, input2_storage, input2_storage, 0, 1856, 64, 64, 1, output0_storage, output0_storage, 0, 1856, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00304_5bec4f4b: benchmark completed");
