...
static uint16_t input0_storage[192512] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 192512, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 3008, 3008, 1, input1_storage, input1_storage, 0, 3008, 2176, 2176, 1, input2_storage, input2_storage, 0, 64, 2176, 2176, 1, output0_storage, output0_storage, 0, 64, 2176, 2176, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00360_b98256dd: benchmark completed");
