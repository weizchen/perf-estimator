...
static uint16_t input0_storage[909312] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 909312, 1);
  fill_f16(input1_storage, 757760, 2);
  fill_f32(input2_storage, 122880, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 2368, 2368, 1, input1_storage, input1_storage, 0, 2368, 320, 320, 1, input2_storage, input2_storage, 0, 384, 320, 320, 1, output0_storage, output0_storage, 0, 384, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00428_17a91384: benchmark completed");
