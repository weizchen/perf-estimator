...
static uint16_t input1_storage[2875392] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 2875392, 2);
  fill_f32(input2_storage, 221184, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 1728, 1728, 1, input2_storage, input2_storage, 0, 128, 1728, 1728, 1, output0_storage, output0_storage, 0, 128, 1728, 1728, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00336_ab478b98: benchmark completed");
