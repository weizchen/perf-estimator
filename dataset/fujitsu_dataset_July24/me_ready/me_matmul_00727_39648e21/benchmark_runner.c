...
static uint16_t input1_storage[2027520] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 2027520, 2);
  fill_f16(input2_storage, 73728, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 3520, 3520, 1, input1_storage, input1_storage, 0, 3520, 576, 576, 1, input2_storage, input2_storage, 0, 128, 576, 576, 1, output0_storage, output0_storage, 0, 128, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00727_39648e21: benchmark completed");
