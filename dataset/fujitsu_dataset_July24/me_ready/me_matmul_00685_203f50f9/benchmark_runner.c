...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 2944, 2944, 1, input1_storage, input1_storage, 0, 2944, 64, 64, 1, input2_storage, input2_storage, 0, 384, 64, 64, 1, output0_storage, output0_storage, 0, 384, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00685_203f50f9: benchmark completed");
