...
static uint8_t input0_storage[491520] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 491520, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 640, 640, 1, input2_storage, input2_storage, 0, 256, 640, 640, 1, output0_storage, output0_storage, 0, 256, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00151_4757675c: benchmark completed");
