...
static uint16_t input1_storage[593920] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 593920, 2);
  fill_f16(input2_storage, 61440, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 1856, 1856, 1, input1_storage, input1_storage, 0, 1856, 320, 320, 1, input2_storage, input2_storage, 0, 192, 320, 320, 1, output0_storage, output0_storage, 0, 192, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00607_5b61d86c: benchmark completed");
