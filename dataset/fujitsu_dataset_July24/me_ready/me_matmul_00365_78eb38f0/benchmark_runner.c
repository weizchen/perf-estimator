...
int main(void) {
  ...
  fill_f16(input1_storage, 401408, 2);
  fill_f32(input2_storage, 114688, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 448, 448, 1, input1_storage, input1_storage, 0, 448, 896, 896, 1, input2_storage, input2_storage, 0, 128, 896, 896, 1, output0_storage, output0_storage, 0, 128, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00365_78eb38f0: benchmark completed");
