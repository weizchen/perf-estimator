...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 3456, 3456, 1, input1_storage, input1_storage, 0, 3456, 256, 256, 1, input2_storage, input2_storage, 0, 128, 256, 256, 1, output0_storage, output0_storage, 0, 128, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00111_40203028: benchmark completed");
