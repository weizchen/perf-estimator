...
static uint8_t input0_storage[180224] __attribute__((aligned(64)));
static uint8_t input1_storage[393216] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 180224, 1);
  fill_f8(input1_storage, 393216, 2);
  fill_f32(input2_storage, 4325376, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1408, 128, 128, 1, input1_storage, input1_storage, 0, 128, 3072, 3072, 1, input2_storage, input2_storage, 0, 1408, 3072, 3072, 1, output0_storage, output0_storage, 0, 1408, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00162_187577da: benchmark completed");
