...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 640, 640, 1, input2_storage, input2_storage, 0, 512, 640, 640, 1, output0_storage, output0_storage, 0, 512, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00144_6e6038b2: benchmark completed");
