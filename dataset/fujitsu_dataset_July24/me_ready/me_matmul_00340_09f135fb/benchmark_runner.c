...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 832, 832, 1, input1_storage, input1_storage, 0, 832, 1792, 1792, 1, input2_storage, input2_storage, 0, 384, 1792, 1792, 1, output0_storage, output0_storage, 0, 384, 1792, 1792, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00340_09f135fb: benchmark completed");
