...
static uint16_t input1_storage[159744] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 159744, 2);
  fill_f32(input2_storage, 294912, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1536, 832, 832, 1, input1_storage, input1_storage, 0, 832, 192, 192, 1, input2_storage, input2_storage, 0, 1536, 192, 192, 1, output0_storage, output0_storage, 0, 1536, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00514_05b1ebfd: benchmark completed");
