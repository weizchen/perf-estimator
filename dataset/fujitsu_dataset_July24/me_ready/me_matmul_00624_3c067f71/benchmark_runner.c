...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 64, 64, 1, input1_storage, input1_storage, 0, 64, 1984, 1984, 1, input2_storage, input2_storage, 0, 64, 1984, 1984, 1, output0_storage, output0_storage, 0, 64, 1984, 1984, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00624_3c067f71: benchmark completed");
