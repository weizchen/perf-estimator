...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 192, 192, 1, input2_storage, input2_storage, 0, 192, 192, 192, 1, output0_storage, output0_storage, 0, 192, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00264_2d3338a9: benchmark completed");
