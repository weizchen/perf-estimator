...
static uint16_t input0_storage[430080] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 430080, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 960, 960, 1, input1_storage, input1_storage, 0, 960, 320, 320, 1, input2_storage, input2_storage, 0, 448, 320, 320, 1, output0_storage, output0_storage, 0, 448, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00492_1b82f896: benchmark completed");
