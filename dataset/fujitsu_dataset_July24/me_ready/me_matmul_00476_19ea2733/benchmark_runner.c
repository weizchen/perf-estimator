...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 192, 192, 1, input1_storage, input1_storage, 0, 192, 192, 192, 1, input2_storage, input2_storage, 0, 640, 192, 192, 1, output0_storage, output0_storage, 0, 640, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00476_19ea2733: benchmark completed");
