...
static uint16_t input0_storage[114688] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 114688, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 256, 256, 1, input1_storage, input1_storage, 0, 256, 1344, 1344, 1, input2_storage, input2_storage, 0, 448, 1344, 1344, 1, output0_storage, output0_storage, 0, 448, 1344, 1344, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00570_dc23ecbd: benchmark completed");
