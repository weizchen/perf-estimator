...
static uint8_t input0_storage[311296] __attribute__((aligned(64)));
static uint8_t input1_storage[1245184] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 311296, 1);
  fill_f8(input1_storage, 1245184, 2);
  fill_f32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2432, 2432, 1, input1_storage, input1_storage, 0, 2432, 512, 512, 1, input2_storage, input2_storage, 0, 128, 512, 512, 1, output0_storage, output0_storage, 0, 128, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00078_76003a19: benchmark completed");
