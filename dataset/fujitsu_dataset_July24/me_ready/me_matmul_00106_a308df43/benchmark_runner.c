...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 3968, 3968, 1, input1_storage, input1_storage, 0, 3968, 256, 256, 1, input2_storage, input2_storage, 0, 512, 256, 256, 1, output0_storage, output0_storage, 0, 512, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00106_a308df43: benchmark completed");
