...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 64, 64, 1, input2_storage, input2_storage, 0, 1152, 64, 64, 1, output0_storage, output0_storage, 0, 1152, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00658_e642c3aa: benchmark completed");
