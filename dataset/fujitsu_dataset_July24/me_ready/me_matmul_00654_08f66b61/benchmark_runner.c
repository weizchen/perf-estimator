...
int main(void) {
  fill_f16(input0_storage, 53248, 1);
  fill_f16(input1_storage, 2555904, 2);
  fill_f16(input2_storage, 196608, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 832, 832, 1, input1_storage, input1_storage, 0, 832, 3072, 3072, 1, input2_storage, input2_storage, 0, 64, 3072, 3072, 1, output0_storage, output0_storage, 0, 64, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00654_08f66b61: benchmark completed");
