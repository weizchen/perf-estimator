...
static uint8_t input0_storage[1261568] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 1261568, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 896, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 2048, 2048, 1, input2_storage, input2_storage, 0, 896, 2048, 2048, 1, output0_storage, output0_storage, 0, 896, 2048, 2048, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00128_61ef472a: benchmark completed");
