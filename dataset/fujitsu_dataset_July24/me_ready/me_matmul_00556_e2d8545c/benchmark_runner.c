...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 704, 2432, 2432, 1, input1_storage, input1_storage, 0, 2432, 384, 384, 1, input2_storage, input2_storage, 0, 704, 384, 384, 1, output0_storage, output0_storage, 0, 704, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00556_e2d8545c: benchmark completed");
