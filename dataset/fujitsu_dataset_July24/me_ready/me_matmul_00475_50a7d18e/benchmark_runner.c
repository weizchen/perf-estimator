...
static float input2_storage[217088] __attribute__((aligned(64)));
static float output0_storage[217088] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f32(input2_storage, 217088, 3);
  ...
  ofa_dma_memory_fence();
  puts("me_matmul_00475_50a7d18e: benchmark completed");
  printf("output0_f32_checksum=%.10e\n", checksum_f32(output0_storage, 217088));
  return 0;
}
