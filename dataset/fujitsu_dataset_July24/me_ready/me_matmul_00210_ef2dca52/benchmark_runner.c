...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 384, 384, 1, input2_storage, input2_storage, 0, 256, 384, 384, 1, output0_storage, output0_storage, 0, 256, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00210_ef2dca52: benchmark completed");
