...
static uint16_t input0_storage[3686400] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 3686400, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 2880, 2880, 1, input1_storage, input1_storage, 0, 2880, 448, 448, 1, input2_storage, input2_storage, 0, 1280, 448, 448, 1, output0_storage, output0_storage, 0, 1280, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00772_2ddb4767: benchmark completed");
