...
static uint8_t input0_storage[8192000] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 8192000, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2560, 3200, 3200, 1, input1_storage, input1_storage, 0, 3200, 384, 384, 1, input2_storage, input2_storage, 0, 2560, 384, 384, 1, output0_storage, output0_storage, 0, 2560, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00254_f9751996: benchmark completed");
