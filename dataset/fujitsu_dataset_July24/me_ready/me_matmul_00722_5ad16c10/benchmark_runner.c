...
static uint16_t input0_storage[4980736] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 4980736, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1216, 4096, 4096, 1, input1_storage, input1_storage, 0, 4096, 768, 768, 1, input2_storage, input2_storage, 0, 1216, 768, 768, 1, output0_storage, output0_storage, 0, 1216, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00722_5ad16c10: benchmark completed");
