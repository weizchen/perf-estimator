...
static uint8_t input1_storage[163840] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 163840, 2);
  fill_f32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 640, 640, 1, input1_storage, input1_storage, 0, 640, 256, 256, 1, input2_storage, input2_storage, 0, 256, 256, 256, 1, output0_storage, output0_storage, 0, 256, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00253_a6d8c01d: benchmark completed");
