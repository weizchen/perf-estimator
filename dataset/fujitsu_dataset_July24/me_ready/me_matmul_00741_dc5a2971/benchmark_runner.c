...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 64, 64, 1, input1_storage, input1_storage, 0, 64, 3840, 3840, 1, input2_storage, input2_storage, 0, 128, 3840, 3840, 1, output0_storage, output0_storage, 0, 128, 3840, 3840, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00741_dc5a2971: benchmark completed");
