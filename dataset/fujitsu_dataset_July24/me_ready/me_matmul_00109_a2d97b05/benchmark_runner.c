...
static uint8_t input1_storage[819200] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 819200, 2);
  fill_f32(input2_storage, 3768320, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2944, 640, 640, 1, input1_storage, input1_storage, 0, 640, 1280, 1280, 1, input2_storage, input2_storage, 0, 2944, 1280, 1280, 1, output0_storage, output0_storage, 0, 2944, 1280, 1280, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00109_a2d97b05: benchmark completed");
