...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 576, 576, 1, input1_storage, input1_storage, 0, 576, 1344, 1344, 1, input2_storage, input2_storage, 0, 256, 1344, 1344, 1, output0_storage, output0_storage, 0, 256, 1344, 1344, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00285_0aee7c76: benchmark completed");
