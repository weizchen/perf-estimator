...
int main(void) {
  fill_f16(input0_storage, 1519616, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3392, 448, 448, 1, input1_storage, input1_storage, 0, 448, 256, 256, 1, input2_storage, input2_storage, 0, 3392, 256, 256, 1, output0_storage, output0_storage, 0, 3392, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00278_2cd1c0e5: benchmark completed");
