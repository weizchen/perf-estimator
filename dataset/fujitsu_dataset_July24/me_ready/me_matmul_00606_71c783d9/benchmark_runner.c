...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 320, 320, 1, input1_storage, input1_storage, 0, 320, 576, 576, 1, input2_storage, input2_storage, 0, 128, 576, 576, 1, output0_storage, output0_storage, 0, 128, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00606_71c783d9: benchmark completed");
