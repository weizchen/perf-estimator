...
static uint16_t input1_storage[487424] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 487424, 2);
  fill_f16(input2_storage, 1671168, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1536, 448, 448, 1, input1_storage, input1_storage, 0, 448, 1088, 1088, 1, input2_storage, input2_storage, 0, 1536, 1088, 1088, 1, output0_storage, output0_storage, 0, 1536, 1088, 1088, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00535_fcad9937: benchmark completed");
