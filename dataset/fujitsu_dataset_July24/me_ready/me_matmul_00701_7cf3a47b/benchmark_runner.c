...
static uint16_t input1_storage[1904640] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1904640, 2);
  fill_f16(input2_storage, 253952, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 960, 960, 1, input1_storage, input1_storage, 0, 960, 1984, 1984, 1, input2_storage, input2_storage, 0, 128, 1984, 1984, 1, output0_storage, output0_storage, 0, 128, 1984, 1984, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00701_7cf3a47b: benchmark completed");
