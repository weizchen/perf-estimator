...
static uint16_t input1_storage[3538944] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 3538944, 2);
  fill_f32(input2_storage, 1572864, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 3072, 3072, 1, input2_storage, input2_storage, 0, 512, 3072, 3072, 1, output0_storage, output0_storage, 0, 512, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00481_c0d6d74d: benchmark completed");
