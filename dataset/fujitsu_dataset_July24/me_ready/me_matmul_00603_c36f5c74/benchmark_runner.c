...
int main(void) {
  ...
  fill_f16(input1_storage, 638976, 2);
  fill_f16(input2_storage, 294912, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 384, 384, 1, input2_storage, input2_storage, 0, 768, 384, 384, 1, output0_storage, output0_storage, 0, 768, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00603_c36f5c74: benchmark completed");
