...
static uint8_t input0_storage[901120] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 901120, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 256, 256, 1, input2_storage, input2_storage, 0, 640, 256, 256, 1, output0_storage, output0_storage, 0, 640, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00236_04d18d7d: benchmark completed");
