...
static uint16_t input1_storage[3993600] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 3993600, 2);
  fill_f32(input2_storage, 307200, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 2496, 2496, 1, input1_storage, input1_storage, 0, 2496, 1600, 1600, 1, input2_storage, input2_storage, 0, 192, 1600, 1600, 1, output0_storage, output0_storage, 0, 192, 1600, 1600, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00350_330730bf: benchmark completed");
