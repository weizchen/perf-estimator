...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 384, 384, 1, input1_storage, input1_storage, 0, 384, 1664, 1664, 1, input2_storage, input2_storage, 0, 128, 1664, 1664, 1, output0_storage, output0_storage, 0, 128, 1664, 1664, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00213_12b2c864: benchmark completed");
