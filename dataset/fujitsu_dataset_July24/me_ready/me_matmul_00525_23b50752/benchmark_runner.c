...
static uint16_t input0_storage[380928] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 380928, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1984, 192, 192, 1, input1_storage, input1_storage, 0, 192, 192, 192, 1, input2_storage, input2_storage, 0, 1984, 192, 192, 1, output0_storage, output0_storage, 0, 1984, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00525_23b50752: benchmark completed");
