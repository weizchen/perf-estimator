...
static uint8_t input1_storage[1277952] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 1277952, 2);
  fill_f32(input2_storage, 983040, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1280, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 768, 768, 1, input2_storage, input2_storage, 0, 1280, 768, 768, 1, output0_storage, output0_storage, 0, 1280, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00260_e2a7b4e9: benchmark completed");
