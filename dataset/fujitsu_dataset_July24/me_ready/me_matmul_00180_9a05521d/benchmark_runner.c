...
static uint8_t input0_storage[425984] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 425984, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1664, 256, 256, 1, input1_storage, input1_storage, 0, 256, 512, 512, 1, input2_storage, input2_storage, 0, 1664, 512, 512, 1, output0_storage, output0_storage, 0, 1664, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00180_9a05521d: benchmark completed");
