...
static uint16_t input0_storage[5898240] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 5898240, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3840, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 192, 192, 1, input2_storage, input2_storage, 0, 3840, 192, 192, 1, output0_storage, output0_storage, 0, 3840, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00362_4d35a779: benchmark completed");
