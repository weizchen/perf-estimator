...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 448, 64, 64, 1, input1_storage, input1_storage, 0, 64, 2816, 2816, 1, input2_storage, input2_storage, 0, 448, 2816, 2816, 1, output0_storage, output0_storage, 0, 448, 2816, 2816, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00400_4c1d5d85: benchmark completed");
