...
static uint16_t input1_storage[10780672] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 10780672, 2);
  fill_f32(input2_storage, 770048, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 3008, 3008, 1, input2_storage, input2_storage, 0, 256, 3008, 3008, 1, output0_storage, output0_storage, 0, 256, 3008, 3008, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00318_afdc0e66: benchmark completed");
