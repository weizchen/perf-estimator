...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1088, 1088, 1, input2_storage, input2_storage, 0, 1152, 1088, 1088, 1, output0_storage, output0_storage, 0, 1152, 1088, 1088, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00641_daf2b8d8: benchmark completed");
