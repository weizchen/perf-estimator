...
static uint8_t input1_storage[655360] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 655360, 2);
  fill_f32(input2_storage, 1720320, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2688, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 640, 640, 1, input2_storage, input2_storage, 0, 2688, 640, 640, 1, output0_storage, output0_storage, 0, 2688, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00145_a184b1ee: benchmark completed");
