...
static uint16_t input0_storage[983040] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 983040, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 960, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 512, 512, 1, input2_storage, input2_storage, 0, 960, 512, 512, 1, output0_storage, output0_storage, 0, 960, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00277_5e9f8cb7: benchmark completed");
