...
static uint8_t input0_storage[884736] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 884736, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 3456, 3456, 1, input1_storage, input1_storage, 0, 3456, 384, 384, 1, input2_storage, input2_storage, 0, 256, 384, 384, 1, output0_storage, output0_storage, 0, 256, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00058_d732363a: benchmark completed");
