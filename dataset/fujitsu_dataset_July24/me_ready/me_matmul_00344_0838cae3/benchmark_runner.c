...
static uint16_t input1_storage[503808] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 503808, 2);
  fill_f32(input2_storage, 36864, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 2624, 2624, 1, input1_storage, input1_storage, 0, 2624, 192, 192, 1, input2_storage, input2_storage, 0, 192, 192, 192, 1, output0_storage, output0_storage, 0, 192, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00344_0838cae3: benchmark completed");
