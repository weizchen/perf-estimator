...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 640, 640, 1, input1_storage, input1_storage, 0, 640, 256, 256, 1, input2_storage, input2_storage, 0, 128, 256, 256, 1, output0_storage, output0_storage, 0, 128, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00141_dc4b7d97: benchmark completed");
