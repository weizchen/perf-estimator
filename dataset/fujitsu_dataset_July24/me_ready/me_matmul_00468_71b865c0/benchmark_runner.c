...
static uint16_t input1_storage[8847360] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 8847360, 2);
  fill_f32(input2_storage, 1966080, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 2880, 2880, 1, input1_storage, input1_storage, 0, 2880, 3072, 3072, 1, input2_storage, input2_storage, 0, 640, 3072, 3072, 1, output0_storage, output0_storage, 0, 640, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00468_71b865c0: benchmark completed");
