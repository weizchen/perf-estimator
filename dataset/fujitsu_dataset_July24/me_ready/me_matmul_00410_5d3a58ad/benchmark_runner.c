...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 640, 64, 64, 1, input1_storage, input1_storage, 0, 64, 3072, 3072, 1, input2_storage, input2_storage, 0, 640, 3072, 3072, 1, output0_storage, output0_storage, 0, 640, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00410_5d3a58ad: benchmark completed");
