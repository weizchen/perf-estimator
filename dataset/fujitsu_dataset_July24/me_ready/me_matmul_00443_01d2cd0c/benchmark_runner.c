...
static uint16_t input0_storage[1105920] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 1105920, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 576, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 256, 256, 1, input2_storage, input2_storage, 0, 576, 256, 256, 1, output0_storage, output0_storage, 0, 576, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00443_01d2cd0c: benchmark completed");
