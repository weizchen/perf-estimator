...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 640, 640, 1, input1_storage, input1_storage, 0, 640, 1152, 1152, 1, input2_storage, input2_storage, 0, 384, 1152, 1152, 1, output0_storage, output0_storage, 0, 384, 1152, 1152, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00233_951e75d9: benchmark completed");
