...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 576, 576, 1, input1_storage, input1_storage, 0, 576, 128, 128, 1, input2_storage, input2_storage, 0, 64, 128, 128, 1, output0_storage, output0_storage, 0, 64, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00780_8b68a11d: benchmark completed");
