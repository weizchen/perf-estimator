...
static uint16_t input1_storage[225280] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 225280, 2);
  fill_f16(input2_storage, 630784, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 896, 320, 320, 1, input1_storage, input1_storage, 0, 320, 704, 704, 1, input2_storage, input2_storage, 0, 896, 704, 704, 1, output0_storage, output0_storage, 0, 896, 704, 704, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00640_315bd54c: benchmark completed");
