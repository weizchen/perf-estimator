...
int main(void) {
  fill_f16(input0_storage, 1064960, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 832, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 256, 256, 1, input2_storage, input2_storage, 0, 832, 256, 256, 1, output0_storage, output0_storage, 0, 832, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00667_50d74bdc: benchmark completed");
