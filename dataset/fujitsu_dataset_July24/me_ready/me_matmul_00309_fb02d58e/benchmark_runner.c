...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 2688, 2688, 1, input1_storage, input1_storage, 0, 2688, 640, 640, 1, input2_storage, input2_storage, 0, 256, 640, 640, 1, output0_storage, output0_storage, 0, 256, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00309_fb02d58e: benchmark completed");
