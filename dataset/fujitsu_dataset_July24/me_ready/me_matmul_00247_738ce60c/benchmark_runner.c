...
static uint8_t input0_storage[409600] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 409600, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 3200, 3200, 1, input1_storage, input1_storage, 0, 3200, 128, 128, 1, input2_storage, input2_storage, 0, 128, 128, 128, 1, output0_storage, output0_storage, 0, 128, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00247_738ce60c: benchmark completed");
