...
static uint16_t input0_storage[3108864] __attribute__((aligned(64)));
static uint16_t input1_storage[270336] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 3108864, 1);
  fill_f16(input1_storage, 270336, 2);
  fill_f16(input2_storage, 188416, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1472, 2112, 2112, 1, input1_storage, input1_storage, 0, 2112, 128, 128, 1, input2_storage, input2_storage, 0, 1472, 128, 128, 1, output0_storage, output0_storage, 0, 1472, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00642_268f5be3: benchmark completed");
