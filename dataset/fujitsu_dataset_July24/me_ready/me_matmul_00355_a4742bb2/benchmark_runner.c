...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 448, 2048, 2048, 1, input1_storage, input1_storage, 0, 2048, 128, 128, 1, input2_storage, input2_storage, 0, 448, 128, 128, 1, output0_storage, output0_storage, 0, 448, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00355_a4742bb2: benchmark completed");
