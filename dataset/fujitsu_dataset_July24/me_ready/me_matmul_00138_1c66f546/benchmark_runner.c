...
static uint8_t input1_storage[3932160] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 3932160, 2);
  fill_f32(input2_storage, 983040, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 2560, 2560, 1, input1_storage, input1_storage, 0, 2560, 1536, 1536, 1, input2_storage, input2_storage, 0, 640, 1536, 1536, 1, output0_storage, output0_storage, 0, 640, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00138_1c66f546: benchmark completed");
