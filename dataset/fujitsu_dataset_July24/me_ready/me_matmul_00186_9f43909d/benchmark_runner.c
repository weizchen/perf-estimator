...
static uint8_t input0_storage[344064] __attribute__((aligned(64)));
static uint8_t input1_storage[1261568] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 344064, 1);
  fill_f8(input1_storage, 1261568, 2);
  fill_f32(input2_storage, 540672, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 896, 896, 1, input1_storage, input1_storage, 0, 896, 1408, 1408, 1, input2_storage, input2_storage, 0, 384, 1408, 1408, 1, output0_storage, output0_storage, 0, 384, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00186_9f43909d: benchmark completed");
