...
static uint8_t input0_storage[5505024] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 5505024, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3584, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 128, 128, 1, input2_storage, input2_storage, 0, 3584, 128, 128, 1, output0_storage, output0_storage, 0, 3584, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00163_5a6a64a8: benchmark completed");
