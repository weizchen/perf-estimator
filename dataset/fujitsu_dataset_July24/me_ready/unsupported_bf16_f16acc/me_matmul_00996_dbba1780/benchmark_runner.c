...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 896, 896, 1, input1_storage, input1_storage, 0, 896, 640, 640, 1, input2_storage, input2_storage, 0, 64, 640, 640, 1, output0_storage, output0_storage, 0, 64, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00996_dbba1780: benchmark completed");
