...
int main(void) {
  fill_bf16(input0_storage, 90112, 1);
  fill_bf16(input1_storage, 45056, 2);
  fill_f16(input2_storage, 8192, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 704, 704, 1, input1_storage, input1_storage, 0, 704, 64, 64, 1, input2_storage, input2_storage, 0, 128, 64, 64, 1, output0_storage, output0_storage, 0, 128, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00984_47e2efc0: benchmark completed");
