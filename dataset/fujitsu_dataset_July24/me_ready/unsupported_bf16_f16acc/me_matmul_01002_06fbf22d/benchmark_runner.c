...
int main(void) {
  fill_bf16(input0_storage, 143360, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 448, 320, 320, 1, input1_storage, input1_storage, 0, 320, 128, 128, 1, input2_storage, input2_storage, 0, 448, 128, 128, 1, output0_storage, output0_storage, 0, 448, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_01002_06fbf22d: benchmark completed");
