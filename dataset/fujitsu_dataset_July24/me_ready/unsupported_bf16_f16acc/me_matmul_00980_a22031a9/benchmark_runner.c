...
int main(void) {
  fill_bf16(input0_storage, 2179072, 1);
  fill_bf16(input1_storage, 77824, 2);
  fill_f16(input2_storage, 114688, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1792, 1216, 1216, 1, input1_storage, input1_storage, 0, 1216, 64, 64, 1, input2_storage, input2_storage, 0, 1792, 64, 64, 1, output0_storage, output0_storage, 0, 1792, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00980_a22031a9: benchmark completed");
