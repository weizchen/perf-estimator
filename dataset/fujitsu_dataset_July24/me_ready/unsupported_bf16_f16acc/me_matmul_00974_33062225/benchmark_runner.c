...
int main(void) {
  fill_bf16(input0_storage, 172032, 1);
  fill_bf16(input1_storage, 86016, 2);
  fill_f16(input2_storage, 73728, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 448, 448, 1, input1_storage, input1_storage, 0, 448, 192, 192, 1, input2_storage, input2_storage, 0, 384, 192, 192, 1, output0_storage, output0_storage, 0, 384, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00974_33062225: benchmark completed");
