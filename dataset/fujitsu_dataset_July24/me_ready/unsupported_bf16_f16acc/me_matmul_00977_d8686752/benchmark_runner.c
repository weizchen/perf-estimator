...
int main(void) {
  fill_bf16(input0_storage, 262144, 1);
  fill_bf16(input1_storage, 196608, 2);
  fill_f16(input2_storage, 196608, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 512, 512, 1, input1_storage, input1_storage, 0, 512, 384, 384, 1, input2_storage, input2_storage, 0, 512, 384, 384, 1, output0_storage, output0_storage, 0, 512, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00977_d8686752: benchmark completed");
