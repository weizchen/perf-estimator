...
int main(void) {
  fill_bf16(input0_storage, 57344, 1);
  fill_bf16(input1_storage, 143360, 2);
  fill_f16(input2_storage, 40960, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 448, 448, 1, input1_storage, input1_storage, 0, 448, 320, 320, 1, input2_storage, input2_storage, 0, 128, 320, 320, 1, output0_storage, output0_storage, 0, 128, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00998_d194ce33: benchmark completed");
