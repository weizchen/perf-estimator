...
int main(void) {
  fill_bf16(input0_storage, 507904, 1);
  fill_bf16(input1_storage, 634880, 2);
  fill_f16(input2_storage, 81920, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 1984, 1984, 1, input1_storage, input1_storage, 0, 1984, 320, 320, 1, input2_storage, input2_storage, 0, 256, 320, 320, 1, output0_storage, output0_storage, 0, 256, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00960_1a257f5d: benchmark completed");
