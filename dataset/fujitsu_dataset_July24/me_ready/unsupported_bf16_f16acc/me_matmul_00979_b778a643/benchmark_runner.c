...
int main(void) {
  ...
  fill_bf16(input1_storage, 24576, 2);
  fill_f16(input2_storage, 225280, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 3520, 384, 384, 1, input1_storage, input1_storage, 0, 384, 64, 64, 1, input2_storage, input2_storage, 0, 3520, 64, 64, 1, output0_storage, output0_storage, 0, 3520, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00979_b778a643: benchmark completed");
