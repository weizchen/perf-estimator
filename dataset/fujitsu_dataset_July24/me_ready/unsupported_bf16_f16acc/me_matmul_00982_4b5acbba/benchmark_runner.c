...
int main(void) {
  fill_bf16(input0_storage, 114688, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 448, 448, 1, input1_storage, input1_storage, 0, 448, 384, 384, 1, input2_storage, input2_storage, 0, 256, 384, 384, 1, output0_storage, output0_storage, 0, 256, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00982_4b5acbba: benchmark completed");
