...
int main(void) {
  ...
  fill_bf16(input1_storage, 16384, 2);
  fill_f16(input2_storage, 163840, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 64, 64, 1, input1_storage, input1_storage, 0, 64, 256, 256, 1, input2_storage, input2_storage, 0, 640, 256, 256, 1, output0_storage, output0_storage, 0, 640, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00997_e3eed5b6: benchmark completed");
