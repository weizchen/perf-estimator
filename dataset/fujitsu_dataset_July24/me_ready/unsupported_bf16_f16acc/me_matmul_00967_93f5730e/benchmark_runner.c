...
int main(void) {
  ...
  fill_bf16(input1_storage, 49152, 2);
  fill_f16(input2_storage, 122880, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 128, 128, 1, input1_storage, input1_storage, 0, 128, 384, 384, 1, input2_storage, input2_storage, 0, 320, 384, 384, 1, output0_storage, output0_storage, 0, 320, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00967_93f5730e: benchmark completed");
