...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 3136, 3136, 1, input1_storage, input1_storage, 0, 3136, 256, 256, 1, input2_storage, input2_storage, 0, 128, 256, 256, 1, output0_storage, output0_storage, 0, 128, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00987_4fe79361: benchmark completed");
