...
static uint8_t input0_storage[1441792] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 1441792, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1024, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 512, 512, 1, input2_storage, input2_storage, 0, 1024, 512, 512, 1, output0_storage, output0_storage, 0, 1024, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00105_8e047e8d: benchmark completed");
