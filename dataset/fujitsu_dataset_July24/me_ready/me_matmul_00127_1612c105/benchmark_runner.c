...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 2944, 2944, 1, input1_storage, input1_storage, 0, 2944, 768, 768, 1, input2_storage, input2_storage, 0, 768, 768, 768, 1, output0_storage, output0_storage, 0, 768, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00127_1612c105: benchmark completed");
