...
static uint16_t input0_storage[1572864] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 1572864, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3072, 512, 512, 1, input1_storage, input1_storage, 0, 512, 384, 384, 1, input2_storage, input2_storage, 0, 3072, 384, 384, 1, output0_storage, output0_storage, 0, 3072, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00665_7c4bd37a: benchmark completed");
