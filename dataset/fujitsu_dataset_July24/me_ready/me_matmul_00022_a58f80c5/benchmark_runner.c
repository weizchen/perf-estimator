...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1024, 512, 512, 1, input1_storage, input1_storage, 0, 512, 896, 896, 1, input2_storage, input2_storage, 0, 1024, 896, 896, 1, output0_storage, output0_storage, 0, 1024, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00022_a58f80c5: benchmark completed");
