...
static uint8_t input0_storage[4128768] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 4128768, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1792, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 128, 128, 1, input2_storage, input2_storage, 0, 1792, 128, 128, 1, output0_storage, output0_storage, 0, 1792, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00252_da4a539e: benchmark completed");
