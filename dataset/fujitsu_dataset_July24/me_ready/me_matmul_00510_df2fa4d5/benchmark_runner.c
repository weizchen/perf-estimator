...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 128, 64, 64, 1, input1_storage, input1_storage, 0, 64, 2688, 2688, 1, input2_storage, input2_storage, 0, 128, 2688, 2688, 1, output0_storage, output0_storage, 0, 128, 2688, 2688, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00510_df2fa4d5: benchmark completed");
