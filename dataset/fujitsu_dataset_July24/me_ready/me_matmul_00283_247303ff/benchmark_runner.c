...
static uint16_t input1_storage[1228800] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1228800, 2);
  fill_f32(input2_storage, 368640, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 960, 960, 1, input2_storage, input2_storage, 0, 384, 960, 960, 1, output0_storage, output0_storage, 0, 384, 960, 960, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00283_247303ff: benchmark completed");
