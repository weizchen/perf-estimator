...
static uint16_t input1_storage[1556480] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1556480, 2);
  fill_f32(input2_storage, 1089536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 448, 640, 640, 1, input1_storage, input1_storage, 0, 640, 2432, 2432, 1, input2_storage, input2_storage, 0, 448, 2432, 2432, 1, output0_storage, output0_storage, 0, 448, 2432, 2432, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00395_3efb36a3: benchmark completed");
