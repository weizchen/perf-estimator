...
static uint8_t input0_storage[98304] __attribute__((aligned(64)));
static uint8_t input1_storage[589824] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 98304, 1);
  fill_f8(input1_storage, 589824, 2);
  ...
  ofa_dma_memory_fence();
  puts("me_matmul_00246_6064f97d: benchmark completed");
