...
static uint16_t input1_storage[4046848] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 4046848, 2);
  fill_f16(input2_storage, 851968, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 1216, 1216, 1, input1_storage, input1_storage, 0, 1216, 3328, 3328, 1, input2_storage, input2_storage, 0, 256, 3328, 3328, 1, output0_storage, output0_storage, 0, 256, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00591_3a72337f: benchmark completed");
