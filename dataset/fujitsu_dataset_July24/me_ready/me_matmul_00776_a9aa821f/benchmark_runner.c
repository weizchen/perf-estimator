...
static uint16_t input1_storage[3096576] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 3096576, 2);
  fill_f16(input2_storage, 344064, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 1344, 1344, 1, input2_storage, input2_storage, 0, 256, 1344, 1344, 1, output0_storage, output0_storage, 0, 256, 1344, 1344, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00776_a9aa821f: benchmark completed");
