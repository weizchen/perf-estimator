...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 128, 128, 1, input1_storage, input1_storage, 0, 128, 192, 192, 1, input2_storage, input2_storage, 0, 512, 192, 192, 1, output0_storage, output0_storage, 0, 512, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00564_cbd7205e: benchmark completed");
