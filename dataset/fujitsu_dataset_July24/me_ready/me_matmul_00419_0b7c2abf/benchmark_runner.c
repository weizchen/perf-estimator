...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 960, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 384, 384, 1, input2_storage, input2_storage, 0, 960, 384, 384, 1, output0_storage, output0_storage, 0, 960, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00419_0b7c2abf: benchmark completed");
