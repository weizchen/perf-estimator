...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 192, 192, 1, input1_storage, input1_storage, 0, 192, 576, 576, 1, input2_storage, input2_storage, 0, 256, 576, 576, 1, output0_storage, output0_storage, 0, 256, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00768_ba5e1158: benchmark completed");
