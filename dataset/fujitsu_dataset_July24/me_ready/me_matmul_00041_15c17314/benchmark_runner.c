...
static uint8_t input1_storage[16384] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 16384, 2);
  fill_f32(input2_storage, 491520, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 3840, 128, 128, 1, input1_storage, input1_storage, 0, 128, 128, 128, 1, input2_storage, input2_storage, 0, 3840, 128, 128, 1, output0_storage, output0_storage, 0, 3840, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00041_15c17314: benchmark completed");
