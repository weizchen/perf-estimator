...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 384, 384, 1, input1_storage, input1_storage, 0, 384, 1664, 1664, 1, input2_storage, input2_storage, 0, 256, 1664, 1664, 1, output0_storage, output0_storage, 0, 256, 1664, 1664, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00048_79b849d0: benchmark completed");
