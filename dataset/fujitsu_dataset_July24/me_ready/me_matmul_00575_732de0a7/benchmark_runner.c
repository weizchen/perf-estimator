...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 320, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 128, 128, 1, input2_storage, input2_storage, 0, 320, 128, 128, 1, output0_storage, output0_storage, 0, 320, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00575_732de0a7: benchmark completed");
