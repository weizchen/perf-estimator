...
static uint16_t input0_storage[851968] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 851968, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 3328, 3328, 1, input1_storage, input1_storage, 0, 3328, 640, 640, 1, input2_storage, input2_storage, 0, 256, 640, 640, 1, output0_storage, output0_storage, 0, 256, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00339_cb30a44a: benchmark completed");
