...
static uint16_t input0_storage[9904128] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 9904128, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2496, 3968, 3968, 1, input1_storage, input1_storage, 0, 3968, 256, 256, 1, input2_storage, input2_storage, 0, 2496, 256, 256, 1, output0_storage, output0_storage, 0, 2496, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00450_5cf83525: benchmark completed");
