...
static uint16_t input1_storage[917504] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 917504, 2);
  fill_f32(input2_storage, 524288, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 448, 448, 1, input1_storage, input1_storage, 0, 448, 2048, 2048, 1, input2_storage, input2_storage, 0, 256, 2048, 2048, 1, output0_storage, output0_storage, 0, 256, 2048, 2048, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00381_4a953c0a: benchmark completed");
