...
int main(void) {
  ...
  fill_bf16(input1_storage, 1474560, 2);
  fill_f32(input2_storage, 491520, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 960, 960, 1, input1_storage, input1_storage, 0, 960, 1536, 1536, 1, input2_storage, input2_storage, 0, 320, 1536, 1536, 1, output0_storage, output0_storage, 0, 320, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00891_a4dc41d5: benchmark completed");
