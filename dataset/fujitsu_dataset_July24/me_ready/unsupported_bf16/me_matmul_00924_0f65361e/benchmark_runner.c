...
static uint16_t input0_storage[1310720] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 1310720, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 512, 2560, 2560, 1, input1_storage, input1_storage, 0, 2560, 576, 576, 1, input2_storage, input2_storage, 0, 512, 576, 576, 1, output0_storage, output0_storage, 0, 512, 576, 576, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00924_0f65361e: benchmark completed");
