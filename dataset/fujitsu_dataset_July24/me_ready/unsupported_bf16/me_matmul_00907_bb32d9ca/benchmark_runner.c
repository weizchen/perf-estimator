...
int main(void) {
  fill_bf16(input0_storage, 73728, 1);
  fill_bf16(input1_storage, 1327104, 2);
  fill_f32(input2_storage, 663552, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 384, 384, 1, input1_storage, input1_storage, 0, 384, 3456, 3456, 1, input2_storage, input2_storage, 0, 192, 3456, 3456, 1, output0_storage, output0_storage, 0, 192, 3456, 3456, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00907_bb32d9ca: benchmark completed");
