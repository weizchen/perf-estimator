...
int main(void) {
  ...
  fill_bf16(input1_storage, 4096, 2);
  fill_f32(input2_storage, 12288, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 64, 64, 1, input1_storage, input1_storage, 0, 64, 64, 64, 1, input2_storage, input2_storage, 0, 192, 64, 64, 1, output0_storage, output0_storage, 0, 192, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00885_fa2c06d2: benchmark completed");
