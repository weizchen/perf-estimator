...
int main(void) {
  fill_bf16(input0_storage, 16384, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 128, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1024, 1024, 1, input2_storage, input2_storage, 0, 128, 1024, 1024, 1, output0_storage, output0_storage, 0, 128, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00941_b1def74e: benchmark completed");
