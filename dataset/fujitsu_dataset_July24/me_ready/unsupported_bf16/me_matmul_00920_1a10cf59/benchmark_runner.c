...
int main(void) {
  fill_bf16(input0_storage, 1105920, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 1728, 1728, 1, input1_storage, input1_storage, 0, 1728, 64, 64, 1, input2_storage, input2_storage, 0, 640, 64, 64, 1, output0_storage, output0_storage, 0, 640, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00920_1a10cf59: benchmark completed");
