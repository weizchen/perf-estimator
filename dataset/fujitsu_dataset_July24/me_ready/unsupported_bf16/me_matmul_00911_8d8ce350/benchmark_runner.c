...
int main(void) {
  ...
  fill_bf16(input1_storage, 491520, 2);
  fill_f32(input2_storage, 16384, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 64, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 256, 256, 1, input2_storage, input2_storage, 0, 64, 256, 256, 1, output0_storage, output0_storage, 0, 64, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00911_8d8ce350: benchmark completed");
