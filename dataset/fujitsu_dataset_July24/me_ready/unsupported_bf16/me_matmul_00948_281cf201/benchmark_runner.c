...
static uint16_t input0_storage[3870720] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 3870720, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 4032, 960, 960, 1, input1_storage, input1_storage, 0, 960, 64, 64, 1, input2_storage, input2_storage, 0, 4032, 64, 64, 1, output0_storage, output0_storage, 0, 4032, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00948_281cf201: benchmark completed");
