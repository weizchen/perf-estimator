...
int main(void) {
  ...
  fill_bf16(input1_storage, 8192, 2);
  fill_f32(input2_storage, 139264, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1088, 64, 64, 1, input1_storage, input1_storage, 0, 64, 128, 128, 1, input2_storage, input2_storage, 0, 1088, 128, 128, 1, output0_storage, output0_storage, 0, 1088, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00877_610c5fc1: benchmark completed");
