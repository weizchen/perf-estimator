...
int main(void) {
  fill_bf16(input0_storage, 159744, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 2496, 2496, 1, input1_storage, input1_storage, 0, 2496, 192, 192, 1, input2_storage, input2_storage, 0, 64, 192, 192, 1, output0_storage, output0_storage, 0, 64, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00927_b11fdb9e: benchmark completed");
