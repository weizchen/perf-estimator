...
static uint16_t input0_storage[962560] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 962560, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3008, 320, 320, 1, input1_storage, input1_storage, 0, 320, 192, 192, 1, input2_storage, input2_storage, 0, 3008, 192, 192, 1, output0_storage, output0_storage, 0, 3008, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00916_aaa560d9: benchmark completed");
