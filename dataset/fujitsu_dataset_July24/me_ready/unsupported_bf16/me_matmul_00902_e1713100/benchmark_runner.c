...
int main(void) {
  fill_bf16(input0_storage, 106496, 1);
  fill_bf16(input1_storage, 245760, 2);
  fill_f32(input2_storage, 1597440, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 832, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1920, 1920, 1, input2_storage, input2_storage, 0, 832, 1920, 1920, 1, output0_storage, output0_storage, 0, 832, 1920, 1920, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00902_e1713100: benchmark completed");
