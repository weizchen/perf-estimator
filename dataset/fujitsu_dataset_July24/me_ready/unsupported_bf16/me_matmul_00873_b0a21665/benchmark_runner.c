...
static uint16_t input0_storage[3194880] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 3194880, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2496, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 192, 192, 1, input2_storage, input2_storage, 0, 2496, 192, 192, 1, output0_storage, output0_storage, 0, 2496, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00873_b0a21665: benchmark completed");
