...
int main(void) {
  fill_bf16(input0_storage, 983040, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 64, 64, 1, input2_storage, input2_storage, 0, 256, 64, 64, 1, output0_storage, output0_storage, 0, 256, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00939_caf35f1f: benchmark completed");
