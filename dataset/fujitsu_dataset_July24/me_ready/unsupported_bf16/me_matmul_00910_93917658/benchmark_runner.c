...
int main(void) {
  ...
  fill_bf16(input1_storage, 458752, 2);
  fill_f32(input2_storage, 49152, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 256, 256, 1, input2_storage, input2_storage, 0, 192, 256, 256, 1, output0_storage, output0_storage, 0, 192, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00910_93917658: benchmark completed");
