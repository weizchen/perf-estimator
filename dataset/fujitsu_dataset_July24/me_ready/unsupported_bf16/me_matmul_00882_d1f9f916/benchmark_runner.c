...
int main(void) {
  fill_bf16(input0_storage, 45056, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 64, 704, 704, 1, input1_storage, input1_storage, 0, 704, 64, 64, 1, input2_storage, input2_storage, 0, 64, 64, 64, 1, output0_storage, output0_storage, 0, 64, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00882_d1f9f916: benchmark completed");
