...
int main(void) {
  fill_bf16(input0_storage, 229376, 1);
  fill_bf16(input1_storage, 57344, 2);
  fill_f32(input2_storage, 65536, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 448, 448, 1, input1_storage, input1_storage, 0, 448, 128, 128, 1, input2_storage, input2_storage, 0, 512, 128, 128, 1, output0_storage, output0_storage, 0, 512, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00936_44c1b93f: benchmark completed");
