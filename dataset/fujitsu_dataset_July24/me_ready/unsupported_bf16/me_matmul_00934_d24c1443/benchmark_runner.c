...
int main(void) {
  fill_bf16(input0_storage, 180224, 1);
  fill_bf16(input1_storage, 1622016, 2);
  fill_f32(input2_storage, 147456, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 1152, 1152, 1, input2_storage, input2_storage, 0, 128, 1152, 1152, 1, output0_storage, output0_storage, 0, 128, 1152, 1152, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00934_d24c1443: benchmark completed");
