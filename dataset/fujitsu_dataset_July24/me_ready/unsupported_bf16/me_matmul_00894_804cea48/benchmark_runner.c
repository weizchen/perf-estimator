...
static uint16_t input1_storage[139264] __attribute__((aligned(64)));
...
int main(void) {
  fill_bf16(input0_storage, 131072, 1);
  fill_bf16(input1_storage, 139264, 2);
  fill_f32(input2_storage, 1114112, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1024, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1088, 1088, 1, input2_storage, input2_storage, 0, 1024, 1088, 1088, 1, output0_storage, output0_storage, 0, 1024, 1088, 1088, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00894_804cea48: benchmark completed");
