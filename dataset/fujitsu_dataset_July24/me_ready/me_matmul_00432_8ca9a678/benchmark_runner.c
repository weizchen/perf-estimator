...
static uint16_t input1_storage[802816] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 802816, 2);
  fill_f32(input2_storage, 131072, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 3136, 3136, 1, input1_storage, input1_storage, 0, 3136, 256, 256, 1, input2_storage, input2_storage, 0, 512, 256, 256, 1, output0_storage, output0_storage, 0, 512, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00432_8ca9a678: benchmark completed");
