...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 960, 960, 1, input1_storage, input1_storage, 0, 960, 768, 768, 1, input2_storage, input2_storage, 0, 192, 768, 768, 1, output0_storage, output0_storage, 0, 192, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00530_6a51871a: benchmark completed");
