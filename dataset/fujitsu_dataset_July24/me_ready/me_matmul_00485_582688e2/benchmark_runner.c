...
static uint16_t input1_storage[1671168] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1671168, 2);
  fill_f32(input2_storage, 262144, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 512, 3264, 3264, 1, input1_storage, input1_storage, 0, 3264, 512, 512, 1, input2_storage, input2_storage, 0, 512, 512, 512, 1, output0_storage, output0_storage, 0, 512, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00485_582688e2: benchmark completed");
