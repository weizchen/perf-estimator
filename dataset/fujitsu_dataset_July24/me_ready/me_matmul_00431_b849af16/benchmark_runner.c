...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 768, 4032, 4032, 1, input1_storage, input1_storage, 0, 4032, 192, 192, 1, input2_storage, input2_storage, 0, 768, 192, 192, 1, output0_storage, output0_storage, 0, 768, 192, 192, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00431_b849af16: benchmark completed");
