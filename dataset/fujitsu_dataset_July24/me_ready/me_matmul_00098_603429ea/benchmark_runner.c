...
static uint8_t input1_storage[901120] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 901120, 2);
  fill_f32(input2_storage, 540672, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 384, 640, 640, 1, input1_storage, input1_storage, 0, 640, 1408, 1408, 1, input2_storage, input2_storage, 0, 384, 1408, 1408, 1, output0_storage, output0_storage, 0, 384, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00098_603429ea: benchmark completed");
