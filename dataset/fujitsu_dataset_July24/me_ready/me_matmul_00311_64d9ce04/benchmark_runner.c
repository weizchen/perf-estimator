...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 1088, 1088, 1, input1_storage, input1_storage, 0, 1088, 448, 448, 1, input2_storage, input2_storage, 0, 192, 448, 448, 1, output0_storage, output0_storage, 0, 192, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00311_64d9ce04: benchmark completed");
