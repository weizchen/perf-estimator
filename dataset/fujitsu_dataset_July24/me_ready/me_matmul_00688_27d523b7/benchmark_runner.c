...
static uint16_t input0_storage[13025280] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 13025280, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3392, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 64, 64, 1, input2_storage, input2_storage, 0, 3392, 64, 64, 1, output0_storage, output0_storage, 0, 3392, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00688_27d523b7: benchmark completed");
