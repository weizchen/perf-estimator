...
static uint8_t input1_storage[1671168] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 1671168, 2);
  fill_f32(input2_storage, 98304, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2176, 2176, 1, input1_storage, input1_storage, 0, 2176, 768, 768, 1, input2_storage, input2_storage, 0, 128, 768, 768, 1, output0_storage, output0_storage, 0, 128, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00075_4869f958: benchmark completed");
