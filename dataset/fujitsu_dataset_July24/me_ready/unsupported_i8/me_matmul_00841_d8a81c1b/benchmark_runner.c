...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 3456, 256, 256, 1, input1_storage, input1_storage, 0, 256, 128, 128, 1, input2_storage, input2_storage, 0, 3456, 128, 128, 1, output0_storage, output0_storage, 0, 3456, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00841_d8a81c1b: benchmark completed");
