...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 128, 128, 1, input2_storage, input2_storage, 0, 256, 128, 128, 1, output0_storage, output0_storage, 0, 256, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00823_0e8b1fe2: benchmark completed");
