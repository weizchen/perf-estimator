...
static int8_t input1_storage[573440] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 573440, 2);
  fill_i32(input2_storage, 2539520, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 3968, 896, 896, 1, input1_storage, input1_storage, 0, 896, 640, 640, 1, input2_storage, input2_storage, 0, 3968, 640, 640, 1, output0_storage, output0_storage, 0, 3968, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00849_db6e6d99: benchmark completed");
