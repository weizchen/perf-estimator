...
static int8_t input0_storage[2375680] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 2375680, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3712, 640, 640, 1, input1_storage, input1_storage, 0, 640, 768, 768, 1, input2_storage, input2_storage, 0, 3712, 768, 768, 1, output0_storage, output0_storage, 0, 3712, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00790_89bf7235: benchmark completed");
