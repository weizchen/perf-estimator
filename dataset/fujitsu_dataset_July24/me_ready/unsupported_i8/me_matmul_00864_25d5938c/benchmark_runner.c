...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 256, 256, 1, input2_storage, input2_storage, 0, 256, 256, 256, 1, output0_storage, output0_storage, 0, 256, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00864_25d5938c: benchmark completed");
