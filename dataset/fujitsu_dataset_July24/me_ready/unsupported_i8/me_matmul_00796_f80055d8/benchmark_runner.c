...
static int8_t input0_storage[1310720] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1310720, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1024, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 256, 256, 1, input2_storage, input2_storage, 0, 1024, 256, 256, 1, output0_storage, output0_storage, 0, 1024, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00796_f80055d8: benchmark completed");
