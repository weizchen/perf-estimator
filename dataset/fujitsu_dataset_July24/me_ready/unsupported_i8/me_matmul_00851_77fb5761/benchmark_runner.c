...
static int8_t input0_storage[1802240] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1802240, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1408, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 256, 256, 1, input2_storage, input2_storage, 0, 1408, 256, 256, 1, output0_storage, output0_storage, 0, 1408, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00851_77fb5761: benchmark completed");
