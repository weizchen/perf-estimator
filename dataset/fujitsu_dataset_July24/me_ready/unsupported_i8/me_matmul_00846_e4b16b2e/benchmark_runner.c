...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 3072, 3072, 1, input2_storage, input2_storage, 0, 256, 3072, 3072, 1, output0_storage, output0_storage, 0, 256, 3072, 3072, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00846_e4b16b2e: benchmark completed");
