...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 640, 640, 1, input1_storage, input1_storage, 0, 640, 1024, 1024, 1, input2_storage, input2_storage, 0, 512, 1024, 1024, 1, output0_storage, output0_storage, 0, 512, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00868_7c831da2: benchmark completed");
