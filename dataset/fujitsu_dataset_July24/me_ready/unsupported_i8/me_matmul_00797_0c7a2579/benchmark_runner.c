...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 3072, 3072, 1, input1_storage, input1_storage, 0, 3072, 256, 256, 1, input2_storage, input2_storage, 0, 256, 256, 256, 1, output0_storage, output0_storage, 0, 256, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00797_0c7a2579: benchmark completed");
