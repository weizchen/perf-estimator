...
static int8_t input0_storage[1245184] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1245184, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2432, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1024, 1024, 1, input2_storage, input2_storage, 0, 2432, 1024, 1024, 1, output0_storage, output0_storage, 0, 2432, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00848_b3081fec: benchmark completed");
