...
static int8_t input1_storage[5898240] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 5898240, 2);
  fill_i32(input2_storage, 1179648, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 3840, 3840, 1, input1_storage, input1_storage, 0, 3840, 1536, 1536, 1, input2_storage, input2_storage, 0, 768, 1536, 1536, 1, output0_storage, output0_storage, 0, 768, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00829_531b6b0b: benchmark completed");
