...
static int8_t input0_storage[3555328] __attribute__((aligned(64)));
static int8_t input1_storage[6094848] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 3555328, 1);
  fill_i8(input1_storage, 6094848, 2);
  fill_i32(input2_storage, 1376256, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 896, 3968, 3968, 1, input1_storage, input1_storage, 0, 3968, 1536, 1536, 1, input2_storage, input2_storage, 0, 896, 1536, 1536, 1, output0_storage, output0_storage, 0, 896, 1536, 1536, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00822_74c58e11: benchmark completed");
