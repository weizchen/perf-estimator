...
static int8_t input0_storage[1769472] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1769472, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 768, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 640, 640, 1, input2_storage, input2_storage, 0, 768, 640, 640, 1, output0_storage, output0_storage, 0, 768, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00805_b5da060d: benchmark completed");
