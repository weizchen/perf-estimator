...
static int8_t input0_storage[4816896] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 4816896, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2688, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 512, 512, 1, input2_storage, input2_storage, 0, 2688, 512, 512, 1, output0_storage, output0_storage, 0, 2688, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00828_122a1676: benchmark completed");
