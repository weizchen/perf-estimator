...
static int8_t input0_storage[589824] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 589824, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 512, 512, 1, input1_storage, input1_storage, 0, 512, 1024, 1024, 1, input2_storage, input2_storage, 0, 1152, 1024, 1024, 1, output0_storage, output0_storage, 0, 1152, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00836_13702abd: benchmark completed");
