...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 256, 256, 1, input1_storage, input1_storage, 0, 256, 3328, 3328, 1, input2_storage, input2_storage, 0, 384, 3328, 3328, 1, output0_storage, output0_storage, 0, 384, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00807_9f0a287c: benchmark completed");
