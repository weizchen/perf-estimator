...
static int8_t input0_storage[1916928] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 1916928, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1152, 1664, 1664, 1, input1_storage, input1_storage, 0, 1664, 256, 256, 1, input2_storage, input2_storage, 0, 1152, 256, 256, 1, output0_storage, output0_storage, 0, 1152, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00799_4275886d: benchmark completed");
