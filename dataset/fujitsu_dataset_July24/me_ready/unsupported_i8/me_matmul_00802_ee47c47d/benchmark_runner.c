...
static int8_t input0_storage[3047424] __attribute__((aligned(64)));
...
int main(void) {
  fill_i8(input0_storage, 3047424, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3968, 768, 768, 1, input1_storage, input1_storage, 0, 768, 512, 512, 1, input2_storage, input2_storage, 0, 3968, 512, 512, 1, output0_storage, output0_storage, 0, 3968, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00802_ee47c47d: benchmark completed");
