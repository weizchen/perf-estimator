...
static int8_t input1_storage[737280] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 737280, 2);
  fill_i32(input2_storage, 49152, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1920, 1920, 1, input1_storage, input1_storage, 0, 1920, 384, 384, 1, input2_storage, input2_storage, 0, 128, 384, 384, 1, output0_storage, output0_storage, 0, 128, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00835_068f2e92: benchmark completed");
