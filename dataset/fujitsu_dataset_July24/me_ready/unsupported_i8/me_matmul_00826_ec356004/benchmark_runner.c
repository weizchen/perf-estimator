...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1920, 1024, 1024, 1, input1_storage, input1_storage, 0, 1024, 256, 256, 1, input2_storage, input2_storage, 0, 1920, 256, 256, 1, output0_storage, output0_storage, 0, 1920, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00826_ec356004: benchmark completed");
