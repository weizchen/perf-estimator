...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 896, 768, 768, 1, input1_storage, input1_storage, 0, 768, 256, 256, 1, input2_storage, input2_storage, 0, 896, 256, 256, 1, output0_storage, output0_storage, 0, 896, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00837_211d1b6d: benchmark completed");
