...
static int8_t input1_storage[5079040] __attribute__((aligned(64)));
static int32_t input2_storage[6094848] __attribute__((aligned(64)));
static int32_t output0_storage[6094848] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_i8(input1_storage, 5079040, 2);
  fill_i32(input2_storage, 6094848, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1536, 1280, 1280, 1, input1_storage, input1_storage, 0, 1280, 3968, 3968, 1, input2_storage, input2_storage, 0, 1536, 3968, 3968, 1, output0_storage, output0_storage, 0, 1536, 3968, 3968, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00830_589f9681: benchmark completed");
  printf("output0_i32_checksum=%lld\n", checksum_i32(output0_storage, 6094848));
  return 0;
}
