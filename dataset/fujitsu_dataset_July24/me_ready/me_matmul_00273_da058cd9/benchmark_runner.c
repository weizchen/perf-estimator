...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1536, 256, 256, 1, input1_storage, input1_storage, 0, 256, 768, 768, 1, input2_storage, input2_storage, 0, 1536, 768, 768, 1, output0_storage, output0_storage, 0, 1536, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00273_da058cd9: benchmark completed");
