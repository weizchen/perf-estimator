...
static uint8_t input0_storage[2211840] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 2211840, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 3456, 3456, 1, input1_storage, input1_storage, 0, 3456, 2048, 2048, 1, input2_storage, input2_storage, 0, 640, 2048, 2048, 1, output0_storage, output0_storage, 0, 640, 2048, 2048, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00185_21a0ec22: benchmark completed");
