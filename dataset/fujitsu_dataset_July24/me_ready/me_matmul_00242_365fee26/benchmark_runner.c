...
static uint8_t input1_storage[245760] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 245760, 2);
  fill_f32(input2_storage, 1310720, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 2048, 384, 384, 1, input1_storage, input1_storage, 0, 384, 640, 640, 1, input2_storage, input2_storage, 0, 2048, 640, 640, 1, output0_storage, output0_storage, 0, 2048, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00242_365fee26: benchmark completed");
