...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1600, 1408, 1408, 1, input1_storage, input1_storage, 0, 1408, 128, 128, 1, input2_storage, input2_storage, 0, 1600, 128, 128, 1, output0_storage, output0_storage, 0, 1600, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00328_9019671e: benchmark completed");
