...
static uint16_t input1_storage[1351680] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 184320, 1);
  fill_f16(input1_storage, 1351680, 2);
  fill_f16(input2_storage, 270336, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 192, 960, 960, 1, input1_storage, input1_storage, 0, 960, 1408, 1408, 1, input2_storage, input2_storage, 0, 192, 1408, 1408, 1, output0_storage, output0_storage, 0, 192, 1408, 1408, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00716_72a74a8c: benchmark completed");
