...
static uint16_t input1_storage[999424] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 999424, 2);
  fill_f32(input2_storage, 499712, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 256, 256, 1, input1_storage, input1_storage, 0, 256, 3904, 3904, 1, input2_storage, input2_storage, 0, 128, 3904, 3904, 1, output0_storage, output0_storage, 0, 128, 3904, 3904, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00291_130348c9: benchmark completed");
