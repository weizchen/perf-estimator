...
static uint8_t input1_storage[835584] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 835584, 2);
  fill_f32(input2_storage, 3342336, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 1536, 384, 384, 1, input1_storage, input1_storage, 0, 384, 2176, 2176, 1, input2_storage, input2_storage, 0, 1536, 2176, 2176, 1, output0_storage, output0_storage, 0, 1536, 2176, 2176, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00028_ab3f6458: benchmark completed");
