...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 2560, 320, 320, 1, input1_storage, input1_storage, 0, 320, 64, 64, 1, input2_storage, input2_storage, 0, 2560, 64, 64, 1, output0_storage, output0_storage, 0, 2560, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00423_28129af9: benchmark completed");
