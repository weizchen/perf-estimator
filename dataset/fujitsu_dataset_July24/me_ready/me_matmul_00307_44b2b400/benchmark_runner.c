...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 256, 1344, 1344, 1, input1_storage, input1_storage, 0, 1344, 320, 320, 1, input2_storage, input2_storage, 0, 256, 320, 320, 1, output0_storage, output0_storage, 0, 256, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00307_44b2b400: benchmark completed");
