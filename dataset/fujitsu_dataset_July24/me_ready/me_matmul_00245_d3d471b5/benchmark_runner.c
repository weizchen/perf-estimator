...
static uint8_t input0_storage[638976] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 638976, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1664, 384, 384, 1, input1_storage, input1_storage, 0, 384, 2560, 2560, 1, input2_storage, input2_storage, 0, 1664, 2560, 2560, 1, output0_storage, output0_storage, 0, 1664, 2560, 2560, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00245_d3d471b5: benchmark completed");
