...
static uint8_t input0_storage[2293760] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 2293760, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 256, 256, 1, input2_storage, input2_storage, 0, 1280, 256, 256, 1, output0_storage, output0_storage, 0, 1280, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00195_62c37775: benchmark completed");
