...
static uint16_t input1_storage[4571136] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 4571136, 2);
  fill_f32(input2_storage, 253952, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2304, 2304, 1, input1_storage, input1_storage, 0, 2304, 1984, 1984, 1, input2_storage, input2_storage, 0, 128, 1984, 1984, 1, output0_storage, output0_storage, 0, 128, 1984, 1984, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00478_ce562f03: benchmark completed");
