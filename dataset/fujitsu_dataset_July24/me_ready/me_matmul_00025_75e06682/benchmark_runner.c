...
static uint8_t input1_storage[4816896] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 4816896, 2);
  fill_f32(input2_storage, 344064, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 1792, 1792, 1, input1_storage, input1_storage, 0, 1792, 2688, 2688, 1, input2_storage, input2_storage, 0, 128, 2688, 2688, 1, output0_storage, output0_storage, 0, 128, 2688, 2688, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00025_75e06682: benchmark completed");
