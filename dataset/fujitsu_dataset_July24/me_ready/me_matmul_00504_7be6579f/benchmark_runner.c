...
static uint16_t input0_storage[2703360] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 2703360, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3840, 704, 704, 1, input1_storage, input1_storage, 0, 704, 64, 64, 1, input2_storage, input2_storage, 0, 3840, 64, 64, 1, output0_storage, output0_storage, 0, 3840, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00504_7be6579f: benchmark completed");
