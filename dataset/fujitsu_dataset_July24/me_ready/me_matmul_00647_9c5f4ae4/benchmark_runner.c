...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 448, 960, 960, 1, input1_storage, input1_storage, 0, 960, 64, 64, 1, input2_storage, input2_storage, 0, 448, 64, 64, 1, output0_storage, output0_storage, 0, 448, 64, 64, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00647_9c5f4ae4: benchmark completed");
