...
static uint16_t input1_storage[4055040] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 4055040, 2);
  fill_f32(input2_storage, 491520, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 2112, 2112, 1, input1_storage, input1_storage, 0, 2112, 1920, 1920, 1, input2_storage, input2_storage, 0, 256, 1920, 1920, 1, output0_storage, output0_storage, 0, 256, 1920, 1920, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00298_f4844d79: benchmark completed");
