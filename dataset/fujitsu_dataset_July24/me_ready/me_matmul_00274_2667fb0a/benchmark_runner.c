...
int main(void) {
  fill_f16(input0_storage, 2408448, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 896, 2688, 2688, 1, input1_storage, input1_storage, 0, 2688, 128, 128, 1, input2_storage, input2_storage, 0, 896, 128, 128, 1, output0_storage, output0_storage, 0, 896, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00274_2667fb0a: benchmark completed");
