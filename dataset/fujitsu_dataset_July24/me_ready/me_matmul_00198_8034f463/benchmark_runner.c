...
static uint8_t input0_storage[196608] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 196608, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 256, 768, 768, 1, input1_storage, input1_storage, 0, 768, 1024, 1024, 1, input2_storage, input2_storage, 0, 256, 1024, 1024, 1, output0_storage, output0_storage, 0, 256, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00198_8034f463: benchmark completed");
