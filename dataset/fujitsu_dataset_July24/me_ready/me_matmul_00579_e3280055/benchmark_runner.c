...
static uint16_t input1_storage[3354624] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 3354624, 2);
  fill_f16(input2_storage, 212992, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 4032, 4032, 1, input1_storage, input1_storage, 0, 4032, 832, 832, 1, input2_storage, input2_storage, 0, 256, 832, 832, 1, output0_storage, output0_storage, 0, 256, 832, 832, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00579_e3280055: benchmark completed");
