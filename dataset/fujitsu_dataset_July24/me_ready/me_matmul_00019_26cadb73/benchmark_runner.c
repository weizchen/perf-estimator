...
static uint8_t input0_storage[1376256] __attribute__((aligned(64)));
static uint8_t input1_storage[1376256] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 1376256, 1);
  fill_f8(input1_storage, 1376256, 2);
  ...
  ofa_dma_memory_fence();
  puts("me_matmul_00019_26cadb73: benchmark completed");
