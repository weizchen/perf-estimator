...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 64, 64, 1, input1_storage, input1_storage, 0, 64, 1600, 1600, 1, input2_storage, input2_storage, 0, 512, 1600, 1600, 1, output0_storage, output0_storage, 0, 512, 1600, 1600, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00413_66a12fe1: benchmark completed");
