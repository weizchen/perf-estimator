...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 384, 384, 1, input1_storage, input1_storage, 0, 384, 1024, 1024, 1, input2_storage, input2_storage, 0, 64, 1024, 1024, 1, output0_storage, output0_storage, 0, 64, 1024, 1024, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00571_b46f1372: benchmark completed");
