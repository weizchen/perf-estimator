...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 384, 512, 512, 1, input1_storage, input1_storage, 0, 512, 896, 896, 1, input2_storage, input2_storage, 0, 384, 896, 896, 1, output0_storage, output0_storage, 0, 384, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00092_8e245d23: benchmark completed");
