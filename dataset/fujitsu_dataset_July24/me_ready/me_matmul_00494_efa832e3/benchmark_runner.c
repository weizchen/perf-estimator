...
static uint16_t input1_storage[6094848] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 6094848, 2);
  fill_f32(input2_storage, 1269760, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 1536, 1536, 1, input1_storage, input1_storage, 0, 1536, 3968, 3968, 1, input2_storage, input2_storage, 0, 320, 3968, 3968, 1, output0_storage, output0_storage, 0, 320, 3968, 3968, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00494_efa832e3: benchmark completed");
