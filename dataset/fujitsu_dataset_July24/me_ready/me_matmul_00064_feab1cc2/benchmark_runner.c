...
static uint8_t input0_storage[2408448] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 2408448, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2688, 896, 896, 1, input1_storage, input1_storage, 0, 896, 512, 512, 1, input2_storage, input2_storage, 0, 2688, 512, 512, 1, output0_storage, output0_storage, 0, 2688, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00064_feab1cc2: benchmark completed");
