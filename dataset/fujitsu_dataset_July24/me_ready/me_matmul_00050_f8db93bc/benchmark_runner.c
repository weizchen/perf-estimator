...
static uint8_t input0_storage[4587520] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 4587520, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1280, 3584, 3584, 1, input1_storage, input1_storage, 0, 3584, 128, 128, 1, input2_storage, input2_storage, 0, 1280, 128, 128, 1, output0_storage, output0_storage, 0, 1280, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00050_f8db93bc: benchmark completed");
