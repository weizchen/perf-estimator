...
static uint16_t input1_storage[1171456] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1171456, 2);
  fill_f16(input2_storage, 425984, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 256, 704, 704, 1, input1_storage, input1_storage, 0, 704, 1664, 1664, 1, input2_storage, input2_storage, 0, 256, 1664, 1664, 1, output0_storage, output0_storage, 0, 256, 1664, 1664, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00657_3b74c38e: benchmark completed");
