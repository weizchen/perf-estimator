...
static uint8_t input0_storage[114688] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 114688, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 896, 128, 128, 1, input1_storage, input1_storage, 0, 128, 1664, 1664, 1, input2_storage, input2_storage, 0, 896, 1664, 1664, 1, output0_storage, output0_storage, 0, 896, 1664, 1664, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00056_4a5ff802: benchmark completed");
