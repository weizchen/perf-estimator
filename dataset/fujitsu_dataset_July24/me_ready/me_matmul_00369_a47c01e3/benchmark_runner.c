...
static uint16_t input0_storage[45056] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 45056, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 704, 64, 64, 1, input1_storage, input1_storage, 0, 64, 640, 640, 1, input2_storage, input2_storage, 0, 704, 640, 640, 1, output0_storage, output0_storage, 0, 704, 640, 640, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00369_a47c01e3: benchmark completed");
