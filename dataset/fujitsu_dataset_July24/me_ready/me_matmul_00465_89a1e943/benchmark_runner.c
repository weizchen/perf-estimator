...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 576, 832, 832, 1, input1_storage, input1_storage, 0, 832, 128, 128, 1, input2_storage, input2_storage, 0, 576, 128, 128, 1, output0_storage, output0_storage, 0, 576, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00465_89a1e943: benchmark completed");
