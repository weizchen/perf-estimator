...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 64, 3264, 3264, 1, input1_storage, input1_storage, 0, 3264, 1280, 1280, 1, input2_storage, input2_storage, 0, 64, 1280, 1280, 1, output0_storage, output0_storage, 0, 64, 1280, 1280, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00517_28b1472d: benchmark completed");
