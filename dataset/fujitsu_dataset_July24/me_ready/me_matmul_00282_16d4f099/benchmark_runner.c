...
static uint16_t input0_storage[4730880] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 4730880, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 1344, 3520, 3520, 1, input1_storage, input1_storage, 0, 3520, 256, 256, 1, input2_storage, input2_storage, 0, 1344, 256, 256, 1, output0_storage, output0_storage, 0, 1344, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00282_16d4f099: benchmark completed");
