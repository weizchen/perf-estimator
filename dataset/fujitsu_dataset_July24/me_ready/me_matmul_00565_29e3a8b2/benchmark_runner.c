...
static uint16_t input1_storage[405504] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 405504, 2);
  fill_f16(input2_storage, 1622016, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 768, 192, 192, 1, input1_storage, input1_storage, 0, 192, 2112, 2112, 1, input2_storage, input2_storage, 0, 768, 2112, 2112, 1, output0_storage, output0_storage, 0, 768, 2112, 2112, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00565_29e3a8b2: benchmark completed");
