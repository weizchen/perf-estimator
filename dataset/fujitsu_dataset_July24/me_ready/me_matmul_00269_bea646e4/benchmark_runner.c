...
static uint16_t input1_storage[1900544] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1900544, 2);
  fill_f32(input2_storage, 163840, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 320, 3712, 3712, 1, input1_storage, input1_storage, 0, 3712, 512, 512, 1, input2_storage, input2_storage, 0, 320, 512, 512, 1, output0_storage, output0_storage, 0, 320, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00269_bea646e4: benchmark completed");
