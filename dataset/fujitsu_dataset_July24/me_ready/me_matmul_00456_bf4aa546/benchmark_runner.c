...
static uint16_t input0_storage[3624960] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 3624960, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 960, 3776, 3776, 1, input1_storage, input1_storage, 0, 3776, 128, 128, 1, input2_storage, input2_storage, 0, 960, 128, 128, 1, output0_storage, output0_storage, 0, 960, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00456_bf4aa546: benchmark completed");
