...
static uint16_t input0_storage[7782400] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 7782400, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 2432, 3200, 3200, 1, input1_storage, input1_storage, 0, 3200, 128, 128, 1, input2_storage, input2_storage, 0, 2432, 128, 128, 1, output0_storage, output0_storage, 0, 2432, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00651_04c1a573: benchmark completed");
