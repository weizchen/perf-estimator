...
static uint16_t input0_storage[3481600] __attribute__((aligned(64)));
...
int main(void) {
  fill_f16(input0_storage, 3481600, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3200, 1088, 1088, 1, input1_storage, input1_storage, 0, 1088, 896, 896, 1, input2_storage, input2_storage, 0, 3200, 896, 896, 1, output0_storage, output0_storage, 0, 3200, 896, 896, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00342_7936e8d3: benchmark completed");
