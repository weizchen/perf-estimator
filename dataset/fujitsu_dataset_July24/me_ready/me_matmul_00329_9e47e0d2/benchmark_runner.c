...
static uint16_t input1_storage[1277952] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f16(input1_storage, 1277952, 2);
  fill_f32(input2_storage, 2129920, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 640, 384, 384, 1, input1_storage, input1_storage, 0, 384, 3328, 3328, 1, input2_storage, input2_storage, 0, 640, 3328, 3328, 1, output0_storage, output0_storage, 0, 640, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00329_9e47e0d2: benchmark completed");
