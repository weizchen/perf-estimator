...
int main(void) {
  fill_f16(input0_storage, 1556480, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 640, 2432, 2432, 1, input1_storage, input1_storage, 0, 2432, 256, 256, 1, input2_storage, input2_storage, 0, 640, 256, 256, 1, output0_storage, output0_storage, 0, 640, 256, 256, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00482_ad21a671: benchmark completed");
