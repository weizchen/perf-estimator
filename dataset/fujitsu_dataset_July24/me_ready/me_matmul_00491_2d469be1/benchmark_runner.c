...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 1600, 320, 320, 1, input1_storage, input1_storage, 0, 320, 512, 512, 1, input2_storage, input2_storage, 0, 1600, 512, 512, 1, output0_storage, output0_storage, 0, 1600, 512, 512, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00491_2d469be1: benchmark completed");
