...
int main(void) {
  ...
  fill_f16(input1_storage, 1175552, 2);
  fill_f32(input2_storage, 57344, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 128, 2624, 2624, 1, input1_storage, input1_storage, 0, 2624, 448, 448, 1, input2_storage, input2_storage, 0, 128, 448, 448, 1, output0_storage, output0_storage, 0, 128, 448, 448, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00522_447fc13f: benchmark completed");
