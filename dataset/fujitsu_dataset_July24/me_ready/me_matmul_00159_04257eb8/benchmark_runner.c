...
static uint8_t input1_storage[10223616] __attribute__((aligned(64)));
...
int main(void) {
  ...
  fill_f8(input1_storage, 10223616, 2);
  fill_f32(input2_storage, 2981888, 3);
  memset(output0_storage, 0, sizeof(output0_storage));
  ofa_dma_memory_fence();
  kernel(input0_storage, input0_storage, 0, 896, 3072, 3072, 1, input1_storage, input1_storage, 0, 3072, 3328, 3328, 1, input2_storage, input2_storage, 0, 896, 3328, 3328, 1, output0_storage, output0_storage, 0, 896, 3328, 3328, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00159_04257eb8: benchmark completed");
