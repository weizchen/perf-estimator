...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 512, 1152, 1152, 1, input1_storage, input1_storage, 0, 1152, 384, 384, 1, input2_storage, input2_storage, 0, 512, 384, 384, 1, output0_storage, output0_storage, 0, 512, 384, 384, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00738_cc9d2e1c: benchmark completed");
