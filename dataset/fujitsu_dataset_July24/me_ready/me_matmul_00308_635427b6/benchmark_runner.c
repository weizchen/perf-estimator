...
int main(void) {
  ...
  kernel(input0_storage, input0_storage, 0, 192, 512, 512, 1, input1_storage, input1_storage, 0, 512, 320, 320, 1, input2_storage, input2_storage, 0, 192, 320, 320, 1, output0_storage, output0_storage, 0, 192, 320, 320, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00308_635427b6: benchmark completed");
