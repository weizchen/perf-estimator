...
static uint8_t input0_storage[1179648] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 1179648, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 3072, 384, 384, 1, input1_storage, input1_storage, 0, 384, 768, 768, 1, input2_storage, input2_storage, 0, 3072, 768, 768, 1, output0_storage, output0_storage, 0, 3072, 768, 768, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00116_7eb79575: benchmark completed");
