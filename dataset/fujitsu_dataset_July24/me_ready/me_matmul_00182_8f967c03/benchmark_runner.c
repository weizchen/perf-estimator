...
static uint8_t input0_storage[1769472] __attribute__((aligned(64)));
...
int main(void) {
  fill_f8(input0_storage, 1769472, 1);
  ...
  kernel(input0_storage, input0_storage, 0, 512, 3456, 3456, 1, input1_storage, input1_storage, 0, 3456, 128, 128, 1, input2_storage, input2_storage, 0, 512, 128, 128, 1, output0_storage, output0_storage, 0, 512, 128, 128, 1);
  ofa_dma_memory_fence();
  puts("me_matmul_00182_8f967c03: benchmark completed");
